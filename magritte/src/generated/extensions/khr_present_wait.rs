...
impl<'lt> PhysicalDevicePresentWaitFeaturesKHR<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDevicePresentWaitFeaturesKHR<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::present_wait`]
    pub fn with_present_wait_raw(mut self, value: Bool32) -> Self {
        self.present_wait = value;
        self
    }
    ...
    ///Sets the value of [`Self::present_wait`]
    pub fn with_present_wait(mut self, value: bool) -> Self {
        self.present_wait = value as u8 as u32;
        self
    }
}
