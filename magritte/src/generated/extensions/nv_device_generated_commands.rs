...
impl std::fmt::Debug for IndirectCommandsTokenTypeNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(IndirectCommandsTokenTypeNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == IndirectCommandsTokenTypeNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        IndirectCommandsTokenTypeNV::SHADER_GROUP => f.write_str("SHADER_GROUP")?,
                        IndirectCommandsTokenTypeNV::STATE_FLAGS => f.write_str("STATE_FLAGS")?,
                        IndirectCommandsTokenTypeNV::INDEX_BUFFER => f.write_str("INDEX_BUFFER")?,
                        IndirectCommandsTokenTypeNV::VERTEX_BUFFER => f.write_str("VERTEX_BUFFER")?,
                        IndirectCommandsTokenTypeNV::PUSH_CONSTANT => f.write_str("PUSH_CONSTANT")?,
                        IndirectCommandsTokenTypeNV::DRAW_INDEXED => f.write_str("DRAW_INDEXED")?,
                        IndirectCommandsTokenTypeNV::DRAW => f.write_str("DRAW")?,
                        IndirectCommandsTokenTypeNV::DRAW_TASKS => f.write_str("DRAW_TASKS")?,
...
impl std::fmt::Debug for IndirectCommandsLayoutUsageFlagBitsNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(IndirectCommandsLayoutUsageFlagBitsNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == IndirectCommandsLayoutUsageFlagBitsNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        IndirectCommandsLayoutUsageFlagBitsNV::EXPLICIT_PREPROCESS => {
                            f.write_str("EXPLICIT_PREPROCESS")?
                        },
                        IndirectCommandsLayoutUsageFlagBitsNV::INDEXED_SEQUENCES => f.write_str("INDEXED_SEQUENCES")?,
                        IndirectCommandsLayoutUsageFlagBitsNV::UNORDERED_SEQUENCES => {
...
impl std::fmt::Debug for IndirectStateFlagBitsNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(IndirectStateFlagBitsNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == IndirectStateFlagBitsNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        IndirectStateFlagBitsNV::FLAG_FRONTFACE => f.write_str("FLAG_FRONTFACE")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl<'lt> PhysicalDeviceDeviceGeneratedCommandsFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceDeviceGeneratedCommandsFeaturesNV<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceDeviceGeneratedCommandsPropertiesNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceDeviceGeneratedCommandsPropertiesNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> GeneratedCommandsMemoryRequirementsInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> GeneratedCommandsMemoryRequirementsInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl IndirectCommandsLayoutNV {
    ...
    pub fn set_name(self: &Unique<Self>, name: &std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_utils::DebugUtilsObjectNameInfoEXT::default()
            .with_object_type(crate::generated::vulkan1_0::ObjectType::INDIRECT_COMMANDS_LAYOUT_NV)
