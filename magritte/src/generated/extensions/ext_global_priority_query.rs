...
use crate::extensions::khr_global_priority::MAX_GLOBAL_PRIORITY_SIZE_KHR;
use std::ffi::CStr;
...
pub const EXT_GLOBAL_PRIORITY_QUERY_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_EXT_global_priority_query");
