...
impl std::fmt::Debug for FullScreenExclusiveEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(FullScreenExclusiveEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == FullScreenExclusiveEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        FullScreenExclusiveEXT::DEFAULT => f.write_str("DEFAULT")?,
                        FullScreenExclusiveEXT::ALLOWED => f.write_str("ALLOWED")?,
                        FullScreenExclusiveEXT::DISALLOWED => f.write_str("DISALLOWED")?,
                        FullScreenExclusiveEXT::APPLICATION_CONTROLLED => f.write_str("APPLICATION_CONTROLLED")?,
...
impl<'lt> SurfaceFullScreenExclusiveInfoEXT<'lt> {
    ...
    pub fn make_static(mut self) -> SurfaceFullScreenExclusiveInfoEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::full_screen_exclusive`]
    pub fn with_full_screen_exclusive(
        mut self,
        value: crate::extensions::ext_full_screen_exclusive::FullScreenExclusiveEXT,
    ) -> Self {
        self.full_screen_exclusive = value;
...
impl<'lt> SurfaceFullScreenExclusiveWin32InfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> SurfaceFullScreenExclusiveWin32InfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::hmonitor`]
    pub fn with_hmonitor_raw(mut self, value: HMONITOR) -> Self {
        self.hmonitor = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::hmonitor`]
    pub fn with_hmonitor(mut self, value: crate::native::HMONITOR) -> Self {
        self.hmonitor = value;
        self
    }
}
...
impl<'lt> SurfaceCapabilitiesFullScreenExclusiveEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> SurfaceCapabilitiesFullScreenExclusiveEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::full_screen_exclusive_supported`]
    pub fn with_full_screen_exclusive_supported_raw(mut self, value: Bool32) -> Self {
        self.full_screen_exclusive_supported = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::full_screen_exclusive_supported`]
    pub fn with_full_screen_exclusive_supported(mut self, value: bool) -> Self {
        self.full_screen_exclusive_supported = value as u8 as u32;
        self
    }
}
