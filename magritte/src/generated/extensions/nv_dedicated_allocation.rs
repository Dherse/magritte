...
impl<'lt> DedicatedAllocationImageCreateInfoNV<'lt> {
    ...
    pub fn make_static(mut self) -> DedicatedAllocationImageCreateInfoNV<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::dedicated_allocation`]
    pub fn with_dedicated_allocation_raw(mut self, value: Bool32) -> Self {
        self.dedicated_allocation = value;
        self
    }
    ...
    ///Sets the value of [`Self::dedicated_allocation`]
    pub fn with_dedicated_allocation(mut self, value: bool) -> Self {
        self.dedicated_allocation = value as u8 as u32;
        self
    }
}
...
impl<'lt> DedicatedAllocationBufferCreateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DedicatedAllocationBufferCreateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> DedicatedAllocationMemoryAllocateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DedicatedAllocationMemoryAllocateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
