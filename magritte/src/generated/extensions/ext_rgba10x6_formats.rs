...
impl<'lt> PhysicalDeviceRgba10x6FormatsFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceRgba10x6FormatsFeaturesEXT<'static> {
        unsafe {
    ...
    ///Gets the raw value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn format_rgba10x6_without_y_cb_cr_sampler_raw(&self) -> Bool32 {
    ...
    ///Sets the raw value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn set_format_rgba10x6_without_y_cb_cr_sampler_raw(&mut self, value: Bool32) -> &mut Self {
        self.format_rgba10x6_without_y_cb_cr_sampler = value;
        self
    }
    ///Sets the raw value of [`Self::p_next`]
    ...
    ///Sets the raw value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn with_format_rgba10x6_without_y_cb_cr_sampler_raw(mut self, value: Bool32) -> Self {
        self.format_rgba10x6_without_y_cb_cr_sampler = value;
        self
    }
    ...
    ///Gets the value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn format_rgba10x6_without_y_cb_cr_sampler(&self) -> bool {
        unsafe { std::mem::transmute(self.format_rgba10x6_without_y_cb_cr_sampler as u8) }
    }
    ...
    ///Gets a mutable reference to the value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn format_rgba10x6_without_y_cb_cr_sampler_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.format_rgba10x6_without_y_cb_cr_sampler as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Sets the value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn set_format_rgba10x6_without_y_cb_cr_sampler(&mut self, value: bool) -> &mut Self {
        self.format_rgba10x6_without_y_cb_cr_sampler = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::format_rgba10x6_without_y_cb_cr_sampler`]
    pub fn with_format_rgba10x6_without_y_cb_cr_sampler(mut self, value: bool) -> Self {
        self.format_rgba10x6_without_y_cb_cr_sampler = value as u8 as u32;
        self
    }
}
