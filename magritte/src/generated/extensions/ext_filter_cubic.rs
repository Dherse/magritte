...
impl<'lt> PhysicalDeviceImageViewImageFormatInfoEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceImageViewImageFormatInfoEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::image_view_type`]
    pub fn with_image_view_type(mut self, value: crate::vulkan1_0::ImageViewType) -> Self {
        self.image_view_type = value;
        self
    }
}
...
impl<'lt> FilterCubicImageViewImageFormatPropertiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> FilterCubicImageViewImageFormatPropertiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::filter_cubic`]
    pub fn with_filter_cubic_raw(mut self, value: Bool32) -> Self {
        self.filter_cubic = value;
        self
    }
    ///Sets the raw value of [`Self::filter_cubic_minmax`]
    pub fn with_filter_cubic_minmax_raw(mut self, value: Bool32) -> Self {
        self.filter_cubic_minmax = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::filter_cubic`]
    pub fn with_filter_cubic(mut self, value: bool) -> Self {
        self.filter_cubic = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::filter_cubic_minmax`]
    pub fn with_filter_cubic_minmax(mut self, value: bool) -> Self {
        self.filter_cubic_minmax = value as u8 as u32;
        self
    }
}
