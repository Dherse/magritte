...
impl std::fmt::Debug for ValidationCacheHeaderVersionEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ValidationCacheHeaderVersionEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ValidationCacheHeaderVersionEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ValidationCacheHeaderVersionEXT::ONE => f.write_str("ONE")?,
...
impl<'lt> ValidationCacheCreateInfoEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::initial_data`]
    pub fn with_initial_data_raw(mut self, value: *const c_void) -> Self {
        self.initial_data = value;
        self
    }
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::ext_validation_cache::ValidationCacheCreateFlagsEXT) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::initial_data_size`]
    pub fn with_initial_data_size(mut self, value: usize) -> Self {
        self.initial_data_size = value;
        self
    }
    ///Sets the value of [`Self::initial_data`]
    pub fn with_initial_data(mut self, value: &'lt [std::ffi::c_void]) -> Self {
        let len_ = value.len() as usize;
        let len_ = len_;
        self.initial_data = value.as_ptr();
        self.initial_data_size = len_;
...
impl<'lt> ShaderModuleValidationCacheCreateInfoEXT<'lt> {
    ...
    pub fn make_static(mut self) -> ShaderModuleValidationCacheCreateInfoEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::validation_cache`]
    pub fn with_validation_cache(mut self, value: crate::extensions::ext_validation_cache::ValidationCacheEXT) -> Self {
        self.validation_cache = value;
        self
    }
}
...
impl ValidationCacheEXT {
    ...
    pub fn set_name(self: &Unique<Self>, name: &std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_utils::DebugUtilsObjectNameInfoEXT::default()
            .with_object_type(crate::generated::vulkan1_0::ObjectType::VALIDATION_CACHE_EXT)
