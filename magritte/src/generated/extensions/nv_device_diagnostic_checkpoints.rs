...
impl<'lt> QueueFamilyCheckpointPropertiesNV<'lt> {
    ...
    pub fn make_static(mut self) -> QueueFamilyCheckpointPropertiesNV<'static> {
        unsafe {
...
impl Queue {
    ...
    pub unsafe fn get_queue_checkpoint_data_nv<'lt>(
        ...
        let mut p_checkpoint_data = SmallVec::<CheckpointDataNV<'lt>>::with_capacity(p_checkpoint_data_count as usize);
