...
/// - [`extended_dynamic_state2`] indicates that the implementation supports the following dynamic
///   states:  - `VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE`  - `VK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLE`
///   - `VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE`
/// - [`extended_dynamic_state2_logic_op`] indicates that the implementation supports the following
///   dynamic state:  - `VK_DYNAMIC_STATE_LOGIC_OP_EXT`
/// - [`extended_dynamic_state2_patch_control_points`] indicates that the implementation supports
...
impl<'lt> PhysicalDeviceExtendedDynamicState2FeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceExtendedDynamicState2FeaturesEXT<'static> {
        unsafe {
    ...
    ///Gets the raw value of [`Self::extended_dynamic_state2`]
    pub fn extended_dynamic_state2_raw(&self) -> Bool32 {
        self.extended_dynamic_state2
    }
    ///Gets the raw value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn extended_dynamic_state2_logic_op_raw(&self) -> Bool32 {
        self.extended_dynamic_state2_logic_op
    }
    ///Gets the raw value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn extended_dynamic_state2_patch_control_points_raw(&self) -> Bool32 {
    ...
    ///Sets the raw value of [`Self::extended_dynamic_state2`]
    pub fn set_extended_dynamic_state2_raw(&mut self, value: Bool32) -> &mut Self {
        self.extended_dynamic_state2 = value;
        self
    }
    ///Sets the raw value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn set_extended_dynamic_state2_logic_op_raw(&mut self, value: Bool32) -> &mut Self {
        self.extended_dynamic_state2_logic_op = value;
        self
    }
    ///Sets the raw value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn set_extended_dynamic_state2_patch_control_points_raw(&mut self, value: Bool32) -> &mut Self {
    ...
    ///Sets the raw value of [`Self::extended_dynamic_state2`]
    pub fn with_extended_dynamic_state2_raw(mut self, value: Bool32) -> Self {
        self.extended_dynamic_state2 = value;
        self
    }
    ///Sets the raw value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn with_extended_dynamic_state2_logic_op_raw(mut self, value: Bool32) -> Self {
        self.extended_dynamic_state2_logic_op = value;
        self
    }
    ///Sets the raw value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn with_extended_dynamic_state2_patch_control_points_raw(mut self, value: Bool32) -> Self {
        self.extended_dynamic_state2_patch_control_points = value;
        self
    }
    ...
    ///Gets the value of [`Self::extended_dynamic_state2`]
    pub fn extended_dynamic_state2(&self) -> bool {
        unsafe { std::mem::transmute(self.extended_dynamic_state2 as u8) }
    }
    ///Gets the value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn extended_dynamic_state2_logic_op(&self) -> bool {
        unsafe { std::mem::transmute(self.extended_dynamic_state2_logic_op as u8) }
    }
    ///Gets the value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn extended_dynamic_state2_patch_control_points(&self) -> bool {
        unsafe { std::mem::transmute(self.extended_dynamic_state2_patch_control_points as u8) }
    }
    ...
    ///Gets a mutable reference to the value of [`Self::extended_dynamic_state2`]
    pub fn extended_dynamic_state2_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.extended_dynamic_state2 as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Gets a mutable reference to the value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn extended_dynamic_state2_logic_op_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.extended_dynamic_state2_logic_op as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    pub fn extended_dynamic_state2_patch_control_points_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.extended_dynamic_state2_patch_control_points as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Sets the value of [`Self::extended_dynamic_state2`]
    pub fn set_extended_dynamic_state2(&mut self, value: bool) -> &mut Self {
        self.extended_dynamic_state2 = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn set_extended_dynamic_state2_logic_op(&mut self, value: bool) -> &mut Self {
        self.extended_dynamic_state2_logic_op = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn set_extended_dynamic_state2_patch_control_points(&mut self, value: bool) -> &mut Self {
        self.extended_dynamic_state2_patch_control_points = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::extended_dynamic_state2`]
    pub fn with_extended_dynamic_state2(mut self, value: bool) -> Self {
        self.extended_dynamic_state2 = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::extended_dynamic_state2_logic_op`]
    pub fn with_extended_dynamic_state2_logic_op(mut self, value: bool) -> Self {
        self.extended_dynamic_state2_logic_op = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::extended_dynamic_state2_patch_control_points`]
    pub fn with_extended_dynamic_state2_patch_control_points(mut self, value: bool) -> Self {
        self.extended_dynamic_state2_patch_control_points = value as u8 as u32;
        self
    }
}
...
impl CommandBuffer {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn cmd_set_logic_op_ext(self: &Unique<CommandBuffer>, logic_op: LogicOp) -> () {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .device()
            .vtable()
