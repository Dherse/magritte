...
impl<'lt> XcbSurfaceCreateInfoKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::window`]
    pub fn with_window_raw(mut self, value: xcb_window_t) -> Self {
        self.window = value;
        self
    }
    ...
    pub fn set_connection(&mut self, value: *mut crate::native::xcb_connection_t) -> &mut Self {
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::khr_xcb_surface::XcbSurfaceCreateFlagsKHR) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::connection`]
    pub fn with_connection(mut self, value: *mut crate::native::xcb_connection_t) -> Self {
        self.connection = value;
        self
    }
    ///Sets the value of [`Self::window`]
    pub fn with_window(mut self, value: crate::native::xcb_window_t) -> Self {
        self.window = value;
        self
    }
}
impl Instance {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn create_xcb_surface_khr<'lt>(
