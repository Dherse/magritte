...
impl<'lt> PhysicalDeviceRayQueryFeaturesKHR<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceRayQueryFeaturesKHR<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::ray_query`]
    pub fn with_ray_query_raw(mut self, value: Bool32) -> Self {
        self.ray_query = value;
        self
    }
    ...
    ///Sets the value of [`Self::ray_query`]
    ...
    ///Sets the value of [`Self::ray_query`]
    pub fn with_ray_query(mut self, value: bool) -> Self {
        self.ray_query = value as u8 as u32;
        self
    }
}
