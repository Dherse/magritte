    ...
    crate::Chain<'other, VideoEncodeH264VclFrameInfoEXT<'extender>> for VideoEncodeInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH264VclFrameInfoEXT<'extender>>) -> Self::Out {
        match new {
    ...
    crate::Chain<'other, VideoEncodeH264EmitPictureParametersEXT<'extender>> for VideoEncodeInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH264EmitPictureParametersEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    crate::Chain<'other, VideoEncodeH265VclFrameInfoEXT<'extender>> for VideoEncodeInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH265VclFrameInfoEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    crate::Chain<'other, VideoEncodeH265EmitPictureParametersEXT<'extender>> for VideoEncodeInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH265EmitPictureParametersEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    crate::Chain<'other, VideoEncodeH264RateControlInfoEXT<'extender>> for VideoEncodeRateControlInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH264RateControlInfoEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    crate::Chain<'other, VideoEncodeH265RateControlInfoEXT<'extender>> for VideoEncodeRateControlInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH265RateControlInfoEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
...
impl<'lt> VideoEncodeRateControlLayerInfoKHR<'lt> {
    ...
    pub fn make_static(mut self) -> VideoEncodeRateControlLayerInfoKHR<'static> {
        unsafe {
    ...
    for VideoEncodeRateControlLayerInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH264RateControlLayerInfoEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    for VideoEncodeRateControlLayerInfoKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH265RateControlLayerInfoEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
...
impl<'lt> VideoEncodeCapabilitiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeCapabilitiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    crate::Chain<'other, VideoEncodeH264CapabilitiesEXT<'extender>> for VideoEncodeCapabilitiesKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH264CapabilitiesEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
    ...
    crate::Chain<'other, VideoEncodeH265CapabilitiesEXT<'extender>> for VideoEncodeCapabilitiesKHR<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoEncodeH265CapabilitiesEXT<'extender>>) -> Self::Out {
        match new {
            Some(new) => self.chain(new),
            None => unsafe { std::mem::transmute(self) },
        }
