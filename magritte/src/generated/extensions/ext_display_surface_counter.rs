...
impl std::fmt::Debug for SurfaceCounterFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(SurfaceCounterFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == SurfaceCounterFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        SurfaceCounterFlagBitsEXT::VBLANK => f.write_str("VBLANK")?,
        ...
        f.debug_tuple(stringify!(SurfaceCounterFlagBitsEXT))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl<'lt> SurfaceCapabilities2EXT<'lt> {
    ...
    pub fn make_static(mut self) -> SurfaceCapabilities2EXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::supported_surface_counters`]
    pub fn with_supported_surface_counters(
        mut self,
        value: crate::extensions::ext_display_surface_counter::SurfaceCounterFlagsEXT,
    ) -> Self {
        self.supported_surface_counters = value;
...
impl PhysicalDevice {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_physical_device_surface_capabilities2_ext<'lt>(
        self: &Unique<PhysicalDevice>,
        surface: SurfaceKHR,
        p_surface_capabilities: Option<SurfaceCapabilities2EXT<'lt>>,
    ) -> VulkanResult<SurfaceCapabilities2EXT<'static>> {
        ...
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                ...
                std::mem::transmute(p_surface_capabilities)
            }),
