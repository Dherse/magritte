...
impl<'lt> Default for PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL<'lt> {
    fn default() -> Self {
        Self {
            ...
            shader_integer_functions2: 0,
        }
    }
}
impl<'lt> PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL<'static> {
        unsafe {
    ...
    ///Gets the raw value of [`Self::shader_integer_functions2`]
    pub fn shader_integer_functions2_raw(&self) -> Bool32 {
    ...
    ///Gets the value of [`Self::shader_integer_functions2`]
    pub fn shader_integer_functions2(&self) -> bool {
        unsafe { std::mem::transmute(self.shader_integer_functions2 as u8) }
    }
    ...
    ///Gets a mutable reference to the value of [`Self::shader_integer_functions2`]
    pub fn shader_integer_functions2_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.shader_integer_functions2 as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
