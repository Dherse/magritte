...
impl std::fmt::Debug for ViewportCoordinateSwizzleNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ViewportCoordinateSwizzleNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ViewportCoordinateSwizzleNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ViewportCoordinateSwizzleNV::POSITIVE_X => f.write_str("POSITIVE_X")?,
                        ViewportCoordinateSwizzleNV::NEGATIVE_X => f.write_str("NEGATIVE_X")?,
                        ViewportCoordinateSwizzleNV::POSITIVE_Y => f.write_str("POSITIVE_Y")?,
                        ViewportCoordinateSwizzleNV::NEGATIVE_Y => f.write_str("NEGATIVE_Y")?,
                        ViewportCoordinateSwizzleNV::POSITIVE_Z => f.write_str("POSITIVE_Z")?,
                        ViewportCoordinateSwizzleNV::NEGATIVE_Z => f.write_str("NEGATIVE_Z")?,
                        ViewportCoordinateSwizzleNV::POSITIVE_W => f.write_str("POSITIVE_W")?,
                        ViewportCoordinateSwizzleNV::NEGATIVE_W => f.write_str("NEGATIVE_W")?,
...
impl ViewportSwizzleNV {
    ...
    ///Sets the value of [`Self::x`]
    pub fn with_x(mut self, value: crate::extensions::nv_viewport_swizzle::ViewportCoordinateSwizzleNV) -> Self {
        self.x = value;
        self
    }
    ///Sets the value of [`Self::y`]
    pub fn with_y(mut self, value: crate::extensions::nv_viewport_swizzle::ViewportCoordinateSwizzleNV) -> Self {
        self.y = value;
        self
    }
    ///Sets the value of [`Self::z`]
    pub fn with_z(mut self, value: crate::extensions::nv_viewport_swizzle::ViewportCoordinateSwizzleNV) -> Self {
        self.z = value;
        self
    }
    ///Sets the value of [`Self::w`]
    pub fn with_w(mut self, value: crate::extensions::nv_viewport_swizzle::ViewportCoordinateSwizzleNV) -> Self {
        self.w = value;
        self
    }
}
...
impl<'lt> PipelineViewportSwizzleStateCreateInfoNV<'lt> {
    ...
    ///Sets the raw value of [`Self::viewport_swizzles`]
    pub fn with_viewport_swizzles_raw(mut self, value: *const ViewportSwizzleNV) -> Self {
        self.viewport_swizzles = value;
        self
    }
