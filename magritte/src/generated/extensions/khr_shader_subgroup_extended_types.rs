...
//! * - Jeff Bolz, NVIDIA  - Jan-Harald Fredriksen, Arm  - Neil Henning, AMD  - Daniel Koch, NVIDIA
//!   - Jeff Leger, Qualcomm  - Graeme Leese, Broadcom  - David Neto, Google  - Daniel Rakos, AMD
//!# Related
//! - [`PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR`]
//!
