...
impl std::fmt::Debug for PipelineExecutableStatisticFormatKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PipelineExecutableStatisticFormatKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PipelineExecutableStatisticFormatKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PipelineExecutableStatisticFormatKHR::BOOL32 => f.write_str("BOOL32")?,
                        PipelineExecutableStatisticFormatKHR::INT64 => f.write_str("INT64")?,
                        PipelineExecutableStatisticFormatKHR::UINT64 => f.write_str("UINT64")?,
                        PipelineExecutableStatisticFormatKHR::FLOAT64 => f.write_str("FLOAT64")?,
...
impl<'lt> PhysicalDevicePipelineExecutablePropertiesFeaturesKHR<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDevicePipelineExecutablePropertiesFeaturesKHR<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::pipeline_executable_info`]
    pub fn with_pipeline_executable_info_raw(mut self, value: Bool32) -> Self {
        self.pipeline_executable_info = value;
        self
    }
    ...
    ///Sets the value of [`Self::pipeline_executable_info`]
    pub fn with_pipeline_executable_info(mut self, value: bool) -> Self {
        self.pipeline_executable_info = value as u8 as u32;
        self
    }
}
...
impl<'lt> PipelineInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PipelineExecutablePropertiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineExecutablePropertiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::stages`]
    pub fn with_stages(mut self, value: crate::vulkan1_0::ShaderStageFlags) -> Self {
        self.stages = value;
        self
    }
    ///Sets the value of [`Self::name`]
...
impl<'lt> PipelineExecutableInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineExecutableInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::executable_index`]
    pub fn with_executable_index(mut self, value: u32) -> Self {
        self.executable_index = value;
        self
    }
}
...
impl<'lt> PipelineExecutableStatisticKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineExecutableStatisticKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PipelineExecutableInternalRepresentationKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::is_text`]
    pub fn with_is_text_raw(mut self, value: Bool32) -> Self {
        self.is_text = value;
        self
    }
    ///Sets the raw value of [`Self::data`]
    pub fn with_data_raw(mut self, value: *mut c_void) -> Self {
        self.data = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::is_text`]
    pub fn with_is_text(mut self, value: bool) -> Self {
        self.is_text = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::data_size`]
    ...
    ///Sets the value of [`Self::data`]
    pub fn with_data(mut self, value: &'lt mut [std::ffi::c_void]) -> Self {
        let len_ = value.len() as usize;
        let len_ = len_;
        self.data = value.as_mut_ptr();
        self.data_size = len_;
...
///```
///# Members
/// - [`b32`] is the 32-bit boolean value if the [`PipelineExecutableStatisticFormatKHR`] is
///   `VK_PIPELINE_EXECUTABLE_STATISTIC_FORMAT_BOOL32_KHR`.
/// - [`i64`] is the signed 64-bit integer value if the [`PipelineExecutableStatisticFormatKHR`] is
///   `VK_PIPELINE_EXECUTABLE_STATISTIC_FORMAT_INT64_KHR`.
/// - [`u64`] is the unsigned 64-bit integer value if the [`PipelineExecutableStatisticFormatKHR`]
