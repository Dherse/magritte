...
//!as input to semaphore state import operations? **RESOLVED** : Implementations must return an
//! error to the application if the
...
//! * - Jason Ekstrand, Intel  - Jesse Hall, Google  - Tobias Hector, Imagination Technologies  -
//!   James Jones, NVIDIA  - Jeff Juliano, NVIDIA  - Matthew Netsch, Qualcomm Technologies, Inc.  -
//!   Ray Smith, ARM  - Chad Versace, Google
//!# Related
