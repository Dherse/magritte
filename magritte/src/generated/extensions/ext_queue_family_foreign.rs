...
//! - The queues represented by [`QUEUE_FAMILY_EXTERNAL_KHR`] must share
//!the same physical device and the same driver version as the current
//![`Instance`].
//![`QUEUE_FAMILY_FOREIGN_EXT`] has no such restrictions.
...
//!Support for [`QUEUE_FAMILY_FOREIGN_EXT`] is more restrictive.
//! - Applications should expect transitions to/from
//![`QUEUE_FAMILY_FOREIGN_EXT`] to be more expensive than transitions
//!to/from [`QUEUE_FAMILY_EXTERNAL_KHR`].
//!# Revision
//!1
//!# Dependencies
//! - Requires Vulkan 1.0
