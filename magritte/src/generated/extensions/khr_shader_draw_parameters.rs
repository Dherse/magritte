...
//! - `BaseVertex`, containing the `firstVertex` or `vertexOffset` parameter passed to drawing
//!   commands, and
//! - `DrawIndex`, containing the index of the draw call currently being processed from an indirect
//!   drawing call.
...
//! * 2017-09-05
//! * No known IP claims.
//! * - This extension requires [`SPV_KHR_shader_draw_parameters`](https://htmlpreview.github.io/?https://github.com/KhronosGroup/SPIRV-Registry/blob/master/extensions/KHR/SPV_KHR_shader_draw_parameters.html)
//!   - This extension provides API support for [`GL_ARB_shader_draw_parameters`](https://www.khronos.org/registry/OpenGL/extensions/ARB/ARB_shader_draw_parameters.txt)
//!   - Promoted to Vulkan 1.1 Core
//! * - Daniel Koch, NVIDIA Corporation  - Jeff Bolz, NVIDIA  - Daniel Rakos, AMD  - Jan-Harald
//!   Fredriksen, ARM  - John Kessenich, Google  - Stuart Smith, IMG
...
pub const KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_KHR_shader_draw_parameters");
