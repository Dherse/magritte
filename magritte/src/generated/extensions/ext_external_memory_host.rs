...
impl<'lt> ImportMemoryHostPointerInfoEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::host_pointer`]
    pub fn with_host_pointer_raw(mut self, value: *mut c_void) -> Self {
        self.host_pointer = value;
        self
    }
    ...
    ///Sets the value of [`Self::host_pointer`]
    pub fn with_host_pointer(mut self, value: &'lt mut std::ffi::c_void) -> Self {
        self.host_pointer = value as *mut _;
        self
    }
}
...
impl<'lt> MemoryHostPointerPropertiesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> MemoryHostPointerPropertiesEXT<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceExternalMemoryHostPropertiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceExternalMemoryHostPropertiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::min_imported_host_pointer_alignment`]
    pub fn with_min_imported_host_pointer_alignment(mut self, value: crate::vulkan1_0::DeviceSize) -> Self {
        self.min_imported_host_pointer_alignment = value;
        self
    }
}
impl Device {
    ...
    pub unsafe fn get_memory_host_pointer_properties_ext<'lt>(
    ...
    ) -> VulkanResult<MemoryHostPointerPropertiesEXT<'static>> {
        ...
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                ...
                std::mem::transmute(p_memory_host_pointer_properties)
            }),
