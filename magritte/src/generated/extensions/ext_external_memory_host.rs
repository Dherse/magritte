...
//!behavior.7) Does this extension support exporting the new handle type?**RESOLVED**: No.8) Should
//! we include the possibility to import host mapped foreign device
