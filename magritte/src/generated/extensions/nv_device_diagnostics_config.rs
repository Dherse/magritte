...
impl<'lt> PhysicalDeviceDiagnosticsConfigFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceDiagnosticsConfigFeaturesNV<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::diagnostics_config`]
    pub fn with_diagnostics_config_raw(mut self, value: Bool32) -> Self {
        self.diagnostics_config = value;
        self
    }
    ...
    ///Sets the value of [`Self::diagnostics_config`]
    pub fn with_diagnostics_config(mut self, value: bool) -> Self {
        self.diagnostics_config = value as u8 as u32;
        self
    }
}
...
impl<'lt> DeviceDiagnosticsConfigCreateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DeviceDiagnosticsConfigCreateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
