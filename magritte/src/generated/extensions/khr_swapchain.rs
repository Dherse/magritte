...
impl SwapchainKHR {
    ...
    pub fn set_name(self: &Unique<Self>, name: &'static std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_marker::DebugMarkerObjectNameInfoEXT::default()
            .with_object_type(crate::generated::extensions::ext_debug_marker::DebugReportObjectTypeEXT::SWAPCHAIN_KHR)
...
impl SwapchainImage {
    ...
    pub fn set_name(self: &Unique<Self>, name: &'static std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_marker::DebugMarkerObjectNameInfoEXT::default()
            .with_object_type(crate::generated::extensions::ext_debug_marker::DebugReportObjectTypeEXT::IMAGE)
            .with_object(self.as_stored() as u64)
            .with_object_name(name.as_ptr());
        unsafe {
            self.device().debug_marker_set_object_name_ext(&info).unwrap();
...
impl SwapchainImageView {
    ...
    pub fn set_name(self: &Unique<Self>, name: &'static std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_marker::DebugMarkerObjectNameInfoEXT::default()
            .with_object_type(crate::generated::extensions::ext_debug_marker::DebugReportObjectTypeEXT::IMAGE_VIEW)
            .with_object(self.as_stored() as u64)
            .with_object_name(name.as_ptr());
        unsafe {
            self.device().debug_marker_set_object_name_ext(&info).unwrap();
