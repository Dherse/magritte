...
//! to a number of additional built-in shader
//!variables in Vulkan:
//! - `SubgroupEqMaskKHR`, containing the subgroup mask of the current subgroup invocation,
//! - `SubgroupGeMaskKHR`, containing the subgroup mask of the invocations greater than or equal to
//!   the current invocation,
//! - `SubgroupGtMaskKHR`, containing the subgroup mask of the invocations greater than the current
//!   invocation,
//! - `SubgroupLeMaskKHR`, containing the subgroup mask of the invocations less than or equal to the
//!   current invocation,
//! - `SubgroupLtMaskKHR`, containing the subgroup mask of the invocations less than the current
//!   invocation,
...
//!   - This extension provides API support for [`GL_ARB_shader_ballot`](https://www.khronos.org/registry/OpenGL/extensions/ARB/ARB_shader_ballot.txt)
...
pub const EXT_SHADER_SUBGROUP_BALLOT_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_EXT_shader_subgroup_ballot");
