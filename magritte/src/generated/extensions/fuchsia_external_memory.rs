...
impl<'lt> ImportMemoryZirconHandleInfoFUCHSIA<'lt> {
    ...
    pub fn make_static(mut self) -> ImportMemoryZirconHandleInfoFUCHSIA<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::handle`]
    pub fn with_handle_raw(mut self, value: zx_handle_t) -> Self {
        self.handle = value;
        self
    }
    ...
    ///Sets the value of [`Self::handle`]
    pub fn with_handle(mut self, value: crate::native::zx_handle_t) -> Self {
        self.handle = value;
        self
    }
}
...
impl<'lt> MemoryZirconHandlePropertiesFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryZirconHandlePropertiesFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> MemoryGetZirconHandleInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryGetZirconHandleInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_memory_zircon_handle_fuchsia<'lt>(
        self: &Unique<Device>,
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_memory_zircon_handle_properties_fuchsia<'lt>(
        self: &Unique<Device>,
        handle_type: ExternalMemoryHandleTypeFlagBits,
        zircon_handle: zx_handle_t,
        p_memory_zircon_handle_properties: Option<MemoryZirconHandlePropertiesFUCHSIA<'lt>>,
    ) -> VulkanResult<MemoryZirconHandlePropertiesFUCHSIA<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .fuchsia_external_memory()
        ...
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                ...
                std::mem::transmute(p_memory_zircon_handle_properties)
            }),
            e => VulkanResult::Err(e),
        }
    }
