...
impl std::fmt::Debug for VideoDecodeH264PictureLayoutFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoDecodeH264PictureLayoutFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoDecodeH264PictureLayoutFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoDecodeH264PictureLayoutFlagBitsEXT::PROGRESSIVE => f.write_str("PROGRESSIVE")?,
                        VideoDecodeH264PictureLayoutFlagBitsEXT::INTERLACED_INTERLEAVED_LINES => {
                            f.write_str("INTERLACED_INTERLEAVED_LINES")?
                        },
                        VideoDecodeH264PictureLayoutFlagBitsEXT::INTERLACED_SEPARATE_PLANES => {
...
impl<'lt> VideoDecodeH264ProfileEXT<'lt> {
    ...
    pub fn make_static(mut self) -> VideoDecodeH264ProfileEXT<'static> {
        unsafe {
...
impl<'lt> VideoDecodeH264CapabilitiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoDecodeH264CapabilitiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    for VideoDecodeH264PictureInfoEXT<'this>
{
    ...
    #[must_use]
    #[inline]
    fn chain_opt(self, new: Option<&'other mut VideoDecodeH264MvcEXT<'extender>>) -> Self::Out {
        match new {
