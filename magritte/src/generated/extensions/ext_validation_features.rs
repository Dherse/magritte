...
impl std::fmt::Debug for ValidationFeatureEnableEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ValidationFeatureEnableEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ValidationFeatureEnableEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ValidationFeatureEnableEXT::GPU_ASSISTED => f.write_str("GPU_ASSISTED")?,
                        ValidationFeatureEnableEXT::GPU_ASSISTED_RESERVE_BINDING_SLOT => {
                            f.write_str("GPU_ASSISTED_RESERVE_BINDING_SLOT")?
                        },
                        ValidationFeatureEnableEXT::BEST_PRACTICES => f.write_str("BEST_PRACTICES")?,
                        ValidationFeatureEnableEXT::DEBUG_PRINTF => f.write_str("DEBUG_PRINTF")?,
                        ValidationFeatureEnableEXT::SYNCHRONIZATION_VALIDATION => {
                            f.write_str("SYNCHRONIZATION_VALIDATION")?
                        },
...
impl std::fmt::Debug for ValidationFeatureDisableEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ValidationFeatureDisableEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ValidationFeatureDisableEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ValidationFeatureDisableEXT::ALL => f.write_str("ALL")?,
                        ValidationFeatureDisableEXT::SHADERS => f.write_str("SHADERS")?,
                        ValidationFeatureDisableEXT::THREAD_SAFETY => f.write_str("THREAD_SAFETY")?,
                        ValidationFeatureDisableEXT::API_PARAMETERS => f.write_str("API_PARAMETERS")?,
                        ValidationFeatureDisableEXT::OBJECT_LIFETIMES => f.write_str("OBJECT_LIFETIMES")?,
                        ValidationFeatureDisableEXT::CORE_CHECKS => f.write_str("CORE_CHECKS")?,
                        ValidationFeatureDisableEXT::UNIQUE_HANDLES => f.write_str("UNIQUE_HANDLES")?,
                        ValidationFeatureDisableEXT::SHADER_VALIDATION_CACHE => {
                            f.write_str("SHADER_VALIDATION_CACHE")?
                        },
                        _ => f.write_str("invalid")?,
                    }
                }
