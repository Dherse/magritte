...
impl<'lt> PhysicalDeviceExternalMemoryRdmaFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceExternalMemoryRdmaFeaturesNV<'static> {
        unsafe {
...
impl<'lt> MemoryGetRemoteAddressInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryGetRemoteAddressInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_memory_remote_address_nv<'lt>(
        self: &Unique<Device>,
        ...
        let _function = self
            .vtable()
            .nv_external_memory_rdma()
            .and_then(|vtable| vtable.get_memory_remote_address_nv())
        ...
        let _function = self
            ...
            .and_then(|vtable| vtable.get_memory_remote_address_nv())
            .unwrap_unchecked();
        let mut p_address = std::mem::zeroed();
        let _return = _function(
            self.as_raw(),
            p_memory_get_remote_address_info as *const MemoryGetRemoteAddressInfoNV<'lt>,
            &mut p_address,
        );
        match _return {
    ...
    pub fn load(
        ...
        Self {
            get_memory_remote_address_nv: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkGetMemoryRemoteAddressNV").as_ptr()))
            },
        }
    }
