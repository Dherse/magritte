...
impl FragmentShadingRateNV {
    ...
    ///[`1_INVOCATION_PER1X2_PIXELS`] specifies
    ///a fragment size of 1x2 pixels.
    pub const _1_INVOCATION_PER1X2_PIXELS: Self = Self(1);
    ///[`1_INVOCATION_PER2X1_PIXELS`] specifies
    ///a fragment size of 2x1 pixels.
    pub const _1_INVOCATION_PER2X1_PIXELS: Self = Self(4);
    ///[`1_INVOCATION_PER2X2_PIXELS`] specifies
    ///a fragment size of 2x2 pixels.
    pub const _1_INVOCATION_PER2X2_PIXELS: Self = Self(5);
    ///[`1_INVOCATION_PER2X4_PIXELS`] specifies
    ///a fragment size of 2x4 pixels.
    pub const _1_INVOCATION_PER2X4_PIXELS: Self = Self(6);
    ///[`1_INVOCATION_PER4X2_PIXELS`] specifies
    ///a fragment size of 4x2 pixels.
    pub const _1_INVOCATION_PER4X2_PIXELS: Self = Self(9);
    ///[`1_INVOCATION_PER4X4_PIXELS`] specifies
    ///a fragment size of 4x4 pixels.
    pub const _1_INVOCATION_PER4X4_PIXELS: Self = Self(10);
...
impl std::fmt::Debug for FragmentShadingRateNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(FragmentShadingRateNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == FragmentShadingRateNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        FragmentShadingRateNV::_1_INVOCATION_PER_PIXEL => f.write_str("1_INVOCATION_PER_PIXEL")?,
                        FragmentShadingRateNV::_1_INVOCATION_PER1X2_PIXELS => {
                            f.write_str("1_INVOCATION_PER1X2_PIXELS")?
                        },
                        FragmentShadingRateNV::_1_INVOCATION_PER2X1_PIXELS => {
                            f.write_str("1_INVOCATION_PER2X1_PIXELS")?
                        },
                        FragmentShadingRateNV::_1_INVOCATION_PER2X2_PIXELS => {
                            f.write_str("1_INVOCATION_PER2X2_PIXELS")?
                        },
                        FragmentShadingRateNV::_1_INVOCATION_PER2X4_PIXELS => {
                            f.write_str("1_INVOCATION_PER2X4_PIXELS")?
                        },
                        FragmentShadingRateNV::_1_INVOCATION_PER4X2_PIXELS => {
                            f.write_str("1_INVOCATION_PER4X2_PIXELS")?
                        },
                        FragmentShadingRateNV::_1_INVOCATION_PER4X4_PIXELS => {
                            f.write_str("1_INVOCATION_PER4X4_PIXELS")?
                        },
                        FragmentShadingRateNV::_2_INVOCATIONS_PER_PIXEL => f.write_str("2_INVOCATIONS_PER_PIXEL")?,
                        FragmentShadingRateNV::_4_INVOCATIONS_PER_PIXEL => f.write_str("4_INVOCATIONS_PER_PIXEL")?,
                        FragmentShadingRateNV::_8_INVOCATIONS_PER_PIXEL => f.write_str("8_INVOCATIONS_PER_PIXEL")?,
                        FragmentShadingRateNV::_16_INVOCATIONS_PER_PIXEL => f.write_str("16_INVOCATIONS_PER_PIXEL")?,
                        FragmentShadingRateNV::NO_INVOCATIONS => f.write_str("NO_INVOCATIONS")?,
...
impl std::fmt::Debug for FragmentShadingRateTypeNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(FragmentShadingRateTypeNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == FragmentShadingRateTypeNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        FragmentShadingRateTypeNV::FRAGMENT_SIZE => f.write_str("FRAGMENT_SIZE")?,
                        FragmentShadingRateTypeNV::ENUMS => f.write_str("ENUMS")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl<'lt> PhysicalDeviceFragmentShadingRateEnumsFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceFragmentShadingRateEnumsFeaturesNV<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::fragment_shading_rate_enums`]
    pub fn with_fragment_shading_rate_enums_raw(mut self, value: Bool32) -> Self {
        self.fragment_shading_rate_enums = value;
        self
    }
    ///Sets the raw value of [`Self::supersample_fragment_shading_rates`]
    pub fn with_supersample_fragment_shading_rates_raw(mut self, value: Bool32) -> Self {
        self.supersample_fragment_shading_rates = value;
        self
    }
    ///Sets the raw value of [`Self::no_invocation_fragment_shading_rates`]
    pub fn with_no_invocation_fragment_shading_rates_raw(mut self, value: Bool32) -> Self {
        self.no_invocation_fragment_shading_rates = value;
        self
    }
    ...
    ///Sets the value of [`Self::fragment_shading_rate_enums`]
    pub fn with_fragment_shading_rate_enums(mut self, value: bool) -> Self {
        self.fragment_shading_rate_enums = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::supersample_fragment_shading_rates`]
    pub fn with_supersample_fragment_shading_rates(mut self, value: bool) -> Self {
        self.supersample_fragment_shading_rates = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::no_invocation_fragment_shading_rates`]
    pub fn with_no_invocation_fragment_shading_rates(mut self, value: bool) -> Self {
        self.no_invocation_fragment_shading_rates = value as u8 as u32;
        self
    }
}
...
impl<'lt> PhysicalDeviceFragmentShadingRateEnumsPropertiesNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceFragmentShadingRateEnumsPropertiesNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PipelineFragmentShadingRateEnumStateCreateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineFragmentShadingRateEnumStateCreateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
