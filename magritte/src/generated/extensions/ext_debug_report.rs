...
impl std::fmt::Debug for DebugReportFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DebugReportFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DebugReportFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        DebugReportFlagBitsEXT::INFORMATION => f.write_str("INFORMATION")?,
                        DebugReportFlagBitsEXT::WARNING => f.write_str("WARNING")?,
                        DebugReportFlagBitsEXT::PERFORMANCE_WARNING => f.write_str("PERFORMANCE_WARNING")?,
                        DebugReportFlagBitsEXT::ERROR => f.write_str("ERROR")?,
                        DebugReportFlagBitsEXT::DEBUG => f.write_str("DEBUG")?,
...
impl<'lt> DebugReportCallbackCreateInfoEXT<'lt> {
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::ext_debug_report::DebugReportFlagsEXT) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::pfn_callback`]
    pub fn with_pfn_callback(mut self, value: crate::extensions::ext_debug_report::PFNDebugReportCallbackEXT) -> Self {
        self.pfn_callback = value;
        self
    }
    ///Sets the value of [`Self::user_data`]
