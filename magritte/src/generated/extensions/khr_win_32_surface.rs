...
//!window object can prevent [`CreateSwapchainKHR`] from succeeding on
//!the same window object.
//! - Creating then destroying a [`SwapchainKHR`] on a window object can
...
//!implementation to create a [`SwapchainKHR`] over the same window
//!object.
