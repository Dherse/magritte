...
impl std::fmt::Debug for DisplayPowerStateEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DisplayPowerStateEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DisplayPowerStateEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        DisplayPowerStateEXT::OFF => f.write_str("OFF")?,
                        DisplayPowerStateEXT::SUSPEND => f.write_str("SUSPEND")?,
                        DisplayPowerStateEXT::ON => f.write_str("ON")?,
...
impl std::fmt::Debug for DeviceEventTypeEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DeviceEventTypeEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DeviceEventTypeEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        DeviceEventTypeEXT::DISPLAY_HOTPLUG => f.write_str("DISPLAY_HOTPLUG")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for DisplayEventTypeEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DisplayEventTypeEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DisplayEventTypeEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        DisplayEventTypeEXT::FIRST_PIXEL_OUT => f.write_str("FIRST_PIXEL_OUT")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl<'lt> DisplayPowerInfoEXT<'lt> {
    ...
    pub fn make_static(mut self) -> DisplayPowerInfoEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::power_state`]
    pub fn with_power_state(mut self, value: crate::extensions::ext_display_control::DisplayPowerStateEXT) -> Self {
        self.power_state = value;
        self
    }
}
...
impl<'lt> DeviceEventInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DeviceEventInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::device_event`]
    pub fn with_device_event(mut self, value: crate::extensions::ext_display_control::DeviceEventTypeEXT) -> Self {
        self.device_event = value;
        self
    }
}
...
impl<'lt> DisplayEventInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DisplayEventInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::display_event`]
    pub fn with_display_event(mut self, value: crate::extensions::ext_display_control::DisplayEventTypeEXT) -> Self {
        self.display_event = value;
        self
    }
}
...
impl<'lt> SwapchainCounterCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> SwapchainCounterCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
