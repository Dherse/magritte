...
/// - [`TRANSFORM8X8`] reports if enabling transform_8x8_mode_flag in StdVideoH264PpsFlags is
///   supported.
...
impl VideoEncodeH264CapabilityFlagBitsEXT {
    ...
    ///supported.
    pub const DIRECT8X8_INFERENCE: Self = Self(1);
...
impl std::fmt::Debug for VideoEncodeH264CapabilityFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH264CapabilityFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH264CapabilityFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH264CapabilityFlagBitsEXT::DIRECT8X8_INFERENCE => {
                            f.write_str("DIRECT8X8_INFERENCE")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::SEPARATE_COLOUR_PLANE => {
                            f.write_str("SEPARATE_COLOUR_PLANE")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::QPPRIME_Y_ZERO_TRANSFORM_BYPASS => {
                            f.write_str("QPPRIME_Y_ZERO_TRANSFORM_BYPASS")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::SCALING_LISTS => f.write_str("SCALING_LISTS")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::HRD_COMPLIANCE => f.write_str("HRD_COMPLIANCE")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::CHROMA_QP_OFFSET => f.write_str("CHROMA_QP_OFFSET")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::SECOND_CHROMA_QP_OFFSET => {
                            f.write_str("SECOND_CHROMA_QP_OFFSET")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::PIC_INIT_QP_MINUS26 => {
                            f.write_str("PIC_INIT_QP_MINUS26")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::WEIGHTED_PRED => f.write_str("WEIGHTED_PRED")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::WEIGHTED_BIPRED_EXPLICIT => {
                            f.write_str("WEIGHTED_BIPRED_EXPLICIT")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::WEIGHTED_BIPRED_IMPLICIT => {
                            f.write_str("WEIGHTED_BIPRED_IMPLICIT")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::WEIGHTED_PRED_NO_TABLE => {
                            f.write_str("WEIGHTED_PRED_NO_TABLE")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::TRANSFORM8X8 => f.write_str("TRANSFORM8X8")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::CABAC => f.write_str("CABAC")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::CAVLC => f.write_str("CAVLC")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::DEBLOCKING_FILTER_DISABLED => {
                            f.write_str("DEBLOCKING_FILTER_DISABLED")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::DEBLOCKING_FILTER_ENABLED => {
                            f.write_str("DEBLOCKING_FILTER_ENABLED")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::DEBLOCKING_FILTER_PARTIAL => {
                            f.write_str("DEBLOCKING_FILTER_PARTIAL")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::DISABLE_DIRECT_SPATIAL_MV_PRED => {
                            f.write_str("DISABLE_DIRECT_SPATIAL_MV_PRED")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::MULTIPLE_SLICE_PER_FRAME => {
                            f.write_str("MULTIPLE_SLICE_PER_FRAME")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::SLICE_MB_COUNT => f.write_str("SLICE_MB_COUNT")?,
                        VideoEncodeH264CapabilityFlagBitsEXT::ROW_UNALIGNED_SLICE => {
                            f.write_str("ROW_UNALIGNED_SLICE")?
                        },
                        VideoEncodeH264CapabilityFlagBitsEXT::DIFFERENT_SLICE_TYPE => {
        ...
        f.debug_tuple(stringify!(VideoEncodeH264CapabilityFlagBitsEXT))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl std::fmt::Debug for VideoEncodeH264InputModeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH264InputModeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH264InputModeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH264InputModeFlagBitsEXT::FRAME => f.write_str("FRAME")?,
                        VideoEncodeH264InputModeFlagBitsEXT::SLICE => f.write_str("SLICE")?,
                        VideoEncodeH264InputModeFlagBitsEXT::NON_VCL => f.write_str("NON_VCL")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
        ...
        f.debug_tuple(stringify!(VideoEncodeH264InputModeFlagBitsEXT))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl std::fmt::Debug for VideoEncodeH264OutputModeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH264OutputModeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH264OutputModeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH264OutputModeFlagBitsEXT::FRAME => f.write_str("FRAME")?,
                        VideoEncodeH264OutputModeFlagBitsEXT::SLICE => f.write_str("SLICE")?,
                        VideoEncodeH264OutputModeFlagBitsEXT::NON_VCL => f.write_str("NON_VCL")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
        ...
        f.debug_tuple(stringify!(VideoEncodeH264OutputModeFlagBitsEXT))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl std::fmt::Debug for VideoEncodeH264RateControlStructureFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH264RateControlStructureFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH264RateControlStructureFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH264RateControlStructureFlagBitsEXT::UNKNOWN => f.write_str("UNKNOWN")?,
                        VideoEncodeH264RateControlStructureFlagBitsEXT::FLAT => f.write_str("FLAT")?,
                        VideoEncodeH264RateControlStructureFlagBitsEXT::DYADIC => f.write_str("DYADIC")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
        ...
        f.debug_tuple(stringify!(VideoEncodeH264RateControlStructureFlagBitsEXT))
            .field(&Flags(*self))
            .finish()
    }
}
...
/// - [`max_p_picture_l0_reference_count`] reports the maximum number of reference pictures the
///   implementation supports in the reference list L0 for P pictures.
/// - [`max_b_picture_l0_reference_count`] reports the maximum number of reference pictures the
...
/// - [`max_l1_reference_count`] reports the maximum number of reference pictures the implementation
///   supports in the reference list L1 if encoding of B pictures is supported. The reported value
///   is `0` if encoding of B pictures is not supported.
...
///   bitstream_restriction_flag is enabled in StdVideoH264SpsVuiFlags.
/// - [`log2_max_mv_length_horizontal`] reports the value that will be used for
...
impl<'lt> VideoEncodeH264CapabilitiesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> VideoEncodeH264CapabilitiesEXT<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::motion_vectors_over_pic_boundaries_flag`]
    pub fn with_motion_vectors_over_pic_boundaries_flag_raw(mut self, value: Bool32) -> Self {
        self.motion_vectors_over_pic_boundaries_flag = value;
        self
    }
    ...
    ///Gets the value of [`Self::max_p_picture_l0_reference_count`]
    pub fn max_p_picture_l0_reference_count(&self) -> u8 {
        self.max_p_picture_l0_reference_count
    }
    ///Gets the value of [`Self::max_b_picture_l0_reference_count`]
    pub fn max_b_picture_l0_reference_count(&self) -> u8 {
        self.max_b_picture_l0_reference_count
    }
    ///Gets the value of [`Self::max_l1_reference_count`]
    pub fn max_l1_reference_count(&self) -> u8 {
        self.max_l1_reference_count
    }
    ...
    ///Gets the value of [`Self::log2_max_mv_length_horizontal`]
    pub fn log2_max_mv_length_horizontal(&self) -> u32 {
        self.log2_max_mv_length_horizontal
    }
    ///Gets the value of [`Self::log2_max_mv_length_vertical`]
    ...
    ///Gets a mutable reference to the value of [`Self::max_p_picture_l0_reference_count`]
    pub fn max_p_picture_l0_reference_count_mut(&mut self) -> &mut u8 {
        &mut self.max_p_picture_l0_reference_count
    }
    ///Gets a mutable reference to the value of [`Self::max_b_picture_l0_reference_count`]
    pub fn max_b_picture_l0_reference_count_mut(&mut self) -> &mut u8 {
        &mut self.max_b_picture_l0_reference_count
    }
    ///Gets a mutable reference to the value of [`Self::max_l1_reference_count`]
    pub fn max_l1_reference_count_mut(&mut self) -> &mut u8 {
        &mut self.max_l1_reference_count
    }
    ...
    ///Gets a mutable reference to the value of [`Self::log2_max_mv_length_horizontal`]
    pub fn log2_max_mv_length_horizontal_mut(&mut self) -> &mut u32 {
        &mut self.log2_max_mv_length_horizontal
    }
    ///Gets a mutable reference to the value of [`Self::log2_max_mv_length_vertical`]
    pub fn log2_max_mv_length_vertical_mut(&mut self) -> &mut u32 {
        &mut self.log2_max_mv_length_vertical
    }
    ...
    pub fn set_flags(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264CapabilityFlagsEXT,
    ) -> &mut Self {
        self.flags = value;
        self
    }
    ...
    pub fn set_input_mode_flags(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264InputModeFlagsEXT,
    ) -> &mut Self {
    ...
    pub fn set_output_mode_flags(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264OutputModeFlagsEXT,
    ) -> &mut Self {
    ...
    ///Sets the value of [`Self::motion_vectors_over_pic_boundaries_flag`]
    ...
    ///Sets the value of [`Self::max_bytes_per_pic_denom`]
    pub fn set_max_bytes_per_pic_denom(&mut self, value: u32) -> &mut Self {
        self.max_bytes_per_pic_denom = value;
        self
    }
    ///Sets the value of [`Self::max_bits_per_mb_denom`]
    pub fn set_max_bits_per_mb_denom(&mut self, value: u32) -> &mut Self {
        self.max_bits_per_mb_denom = value;
        self
    }
    ///Sets the value of [`Self::log2_max_mv_length_horizontal`]
    pub fn set_log2_max_mv_length_horizontal(&mut self, value: u32) -> &mut Self {
        self.log2_max_mv_length_horizontal = value;
        self
    }
    ///Sets the value of [`Self::log2_max_mv_length_vertical`]
    pub fn set_log2_max_mv_length_vertical(&mut self, value: u32) -> &mut Self {
        self.log2_max_mv_length_vertical = value;
        self
    }
    ///Sets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::motion_vectors_over_pic_boundaries_flag`]
    pub fn with_motion_vectors_over_pic_boundaries_flag(mut self, value: bool) -> Self {
        self.motion_vectors_over_pic_boundaries_flag = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::max_bytes_per_pic_denom`]
    pub fn with_max_bytes_per_pic_denom(mut self, value: u32) -> Self {
        self.max_bytes_per_pic_denom = value;
        self
    }
    ///Sets the value of [`Self::max_bits_per_mb_denom`]
    pub fn with_max_bits_per_mb_denom(mut self, value: u32) -> Self {
        self.max_bits_per_mb_denom = value;
        self
    }
    ///Sets the value of [`Self::log2_max_mv_length_horizontal`]
    pub fn with_log2_max_mv_length_horizontal(mut self, value: u32) -> Self {
        self.log2_max_mv_length_horizontal = value;
        self
    }
    ///Sets the value of [`Self::log2_max_mv_length_vertical`]
    pub fn with_log2_max_mv_length_vertical(mut self, value: u32) -> Self {
        self.log2_max_mv_length_vertical = value;
        self
    }
}
...
impl<'lt> VideoEncodeH264SessionParametersCreateInfoEXT<'lt> {
    ...
    pub fn set_parameters_add_info(
        &mut self,
        value: &'lt crate::extensions::ext_video_encode_h264::VideoEncodeH264SessionParametersAddInfoEXT<'lt>,
    ) -> &mut Self {
...
impl<'lt> VideoEncodeH264DpbSlotInfoEXT<'lt> {
    ...
    pub fn std_reference_info(&self) -> *const StdVideoEncodeH264ReferenceInfo {
    ...
    pub fn set_std_reference_info(
        &mut self,
        value: *const crate::native::StdVideoEncodeH264ReferenceInfo,
    ) -> &mut Self {
    ...
    ///Sets the value of [`Self::std_reference_info`]
    pub fn with_std_reference_info(mut self, value: *const crate::native::StdVideoEncodeH264ReferenceInfo) -> Self {
        self.std_reference_info = value;
        self
    }
}
...
impl<'lt> VideoEncodeH264VclFrameInfoEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::reference_final_lists`]
    pub fn with_reference_final_lists_raw(mut self, value: *const VideoEncodeH264ReferenceListsEXT<'lt>) -> Self {
        self.reference_final_lists = value;
        self
    }
    ///Sets the raw value of [`Self::nalu_slice_entries`]
    pub fn with_nalu_slice_entries_raw(mut self, value: *const VideoEncodeH264NaluSliceEXT<'lt>) -> Self {
        self.nalu_slice_entries = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    pub fn current_picture_info(&self) -> *const StdVideoEncodeH264PictureInfo {
    ...
    pub fn set_reference_final_lists(
        &mut self,
        value: &'lt crate::extensions::ext_video_encode_h264::VideoEncodeH264ReferenceListsEXT<'lt>,
    ) -> &mut Self {
        self.reference_final_lists = value as *const _;
        self
    }
    ///Sets the value of [`Self::nalu_slice_entry_count`]
    pub fn set_nalu_slice_entry_count(&mut self, value: u32) -> &mut Self {
        self.nalu_slice_entry_count = value;
        self
    }
    ///Sets the value of [`Self::nalu_slice_entries`]
    pub fn set_nalu_slice_entries(
        &mut self,
        value: &'lt [crate::extensions::ext_video_encode_h264::VideoEncodeH264NaluSliceEXT<'lt>],
    ) -> &mut Self {
    ...
    pub fn set_current_picture_info(
        &mut self,
        value: *const crate::native::StdVideoEncodeH264PictureInfo,
    ) -> &mut Self {
    ...
    ///Sets the value of [`Self::nalu_slice_entry_count`]
    pub fn with_nalu_slice_entry_count(mut self, value: u32) -> Self {
        self.nalu_slice_entry_count = value;
        self
    }
    ///Sets the value of [`Self::nalu_slice_entries`]
    pub fn with_nalu_slice_entries(
        mut self,
        value: &'lt [crate::extensions::ext_video_encode_h264::VideoEncodeH264NaluSliceEXT<'lt>],
    ) -> Self {
        let len_ = value.len() as u32;
    ...
    ///Sets the value of [`Self::current_picture_info`]
    pub fn with_current_picture_info(mut self, value: *const crate::native::StdVideoEncodeH264PictureInfo) -> Self {
        self.current_picture_info = value;
        self
    }
}
...
/// - [`reference_list0_entries`] is a pointer to an array of
///   [`reference_list0_entry_count`][`VideoEncodeH264DpbSlotInfoEXT`] structures specifying the
...
/// - [`reference_list1_entry_count`] is the number of reference pictures in reference list L1 and
///   is identical to [`StdVideoEncodeH264SliceHeader`]`::num_ref_idx_l1_active_minus1` + 1.
/// - [`reference_list1_entries`] is a pointer to an array of
///   [`reference_list1_entry_count`][`VideoEncodeH264DpbSlotInfoEXT`] structures specifying the
...
///   valid pointer to an array of [`reference_list0_entry_count`] valid
///   [`VideoEncodeH264DpbSlotInfoEXT`] structures
/// - If [`reference_list1_entry_count`] is not `0`, [`reference_list1_entries`] **must**  be a
///   valid pointer to an array of [`reference_list1_entry_count`] valid
///   [`VideoEncodeH264DpbSlotInfoEXT`] structures
...
pub struct VideoEncodeH264ReferenceListsEXT<'lt> {
    ...
    ///structure.
    pub p_next: *const BaseInStructure<'lt>,
    ///[`reference_list0_entry_count`] is the number of reference pictures in
    ...
    ///[`reference_list0_entries`] is a pointer to an array of
    ///[`reference_list0_entry_count`][`VideoEncodeH264DpbSlotInfoEXT`]
    ...
    pub reference_list0_entries: *const VideoEncodeH264DpbSlotInfoEXT<'lt>,
    ///[`reference_list1_entry_count`] is the number of reference pictures in
    ...
    ///[`reference_list1_entries`] is a pointer to an array of
    ///[`reference_list1_entry_count`][`VideoEncodeH264DpbSlotInfoEXT`]
    ...
    ///provided in the `pReferenceSlots` of the parent
    ///[`VideoEncodeInfoKHR`] structure.
    pub reference_list1_entries: *const VideoEncodeH264DpbSlotInfoEXT<'lt>,
...
impl<'lt> Default for VideoEncodeH264ReferenceListsEXT<'lt> {
    fn default() -> Self {
        Self {
            ...
            p_next: std::ptr::null(),
            reference_list0_entry_count: 0,
            reference_list0_entries: std::ptr::null(),
            reference_list1_entry_count: 0,
            reference_list1_entries: std::ptr::null(),
...
impl<'lt> VideoEncodeH264ReferenceListsEXT<'lt> {
    ...
    ///Gets the raw value of [`Self::reference_list0_entries`]
    pub fn reference_list0_entries_raw(&self) -> *const VideoEncodeH264DpbSlotInfoEXT<'lt> {
        self.reference_list0_entries
    }
    ///Gets the raw value of [`Self::reference_list1_entries`]
    pub fn reference_list1_entries_raw(&self) -> *const VideoEncodeH264DpbSlotInfoEXT<'lt> {
    ...
    pub fn set_reference_list0_entries_raw(&mut self, value: *const VideoEncodeH264DpbSlotInfoEXT<'lt>) -> &mut Self {
        self.reference_list0_entries = value;
        self
    }
    ///Sets the raw value of [`Self::reference_list1_entries`]
    pub fn set_reference_list1_entries_raw(&mut self, value: *const VideoEncodeH264DpbSlotInfoEXT<'lt>) -> &mut Self {
    ...
    ///Sets the raw value of [`Self::reference_list0_entries`]
    pub fn with_reference_list0_entries_raw(mut self, value: *const VideoEncodeH264DpbSlotInfoEXT<'lt>) -> Self {
        self.reference_list0_entries = value;
        self
    }
    ///Sets the raw value of [`Self::reference_list1_entries`]
    pub fn with_reference_list1_entries_raw(mut self, value: *const VideoEncodeH264DpbSlotInfoEXT<'lt>) -> Self {
        self.reference_list1_entries = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Gets the value of [`Self::reference_list0_entry_count`]
    pub fn reference_list0_entry_count(&self) -> u8 {
        self.reference_list0_entry_count
    }
    ///Gets the value of [`Self::reference_list0_entries`]
    ///# Safety
    ///This function converts a pointer into a value which may be invalid, make sure
    ///that the pointer is valid before dereferencing.
    pub unsafe fn reference_list0_entries(&self) -> &[VideoEncodeH264DpbSlotInfoEXT<'lt>] {
        std::slice::from_raw_parts(self.reference_list0_entries, self.reference_list0_entry_count as usize)
    }
    ///Gets the value of [`Self::reference_list1_entry_count`]
    pub fn reference_list1_entry_count(&self) -> u8 {
        self.reference_list1_entry_count
    }
    ///Gets the value of [`Self::reference_list1_entries`]
    ///# Safety
    ///This function converts a pointer into a value which may be invalid, make sure
    ///that the pointer is valid before dereferencing.
    pub unsafe fn reference_list1_entries(&self) -> &[VideoEncodeH264DpbSlotInfoEXT<'lt>] {
        std::slice::from_raw_parts(self.reference_list1_entries, self.reference_list1_entry_count as usize)
    }
    ///Gets the value of [`Self::mem_mgmt_ctrl_operations`]
    pub fn mem_mgmt_ctrl_operations(&self) -> *const StdVideoEncodeH264RefMemMgmtCtrlOperations {
    ...
    ///Gets a mutable reference to the value of [`Self::reference_list0_entry_count`]
    pub fn reference_list0_entry_count_mut(&mut self) -> &mut u8 {
        &mut self.reference_list0_entry_count
    }
    ///Gets a mutable reference to the value of [`Self::reference_list1_entry_count`]
    pub fn reference_list1_entry_count_mut(&mut self) -> &mut u8 {
    ...
    pub fn set_reference_list0_entries(
        &mut self,
        value: &'lt [crate::extensions::ext_video_encode_h264::VideoEncodeH264DpbSlotInfoEXT<'lt>],
    ) -> &mut Self {
    ...
    ///Sets the value of [`Self::mem_mgmt_ctrl_operations`]
    pub fn set_mem_mgmt_ctrl_operations(
        &mut self,
        value: *const crate::native::StdVideoEncodeH264RefMemMgmtCtrlOperations,
    ) -> &mut Self {
        self.mem_mgmt_ctrl_operations = value;
        self
    }
    ///Sets the value of [`Self::s_type`]
    pub fn with_s_type(mut self, value: crate::vulkan1_0::StructureType) -> Self {
    ...
    ///Sets the value of [`Self::mem_mgmt_ctrl_operations`]
    pub fn with_mem_mgmt_ctrl_operations(
        mut self,
        value: *const crate::native::StdVideoEncodeH264RefMemMgmtCtrlOperations,
    ) -> Self {
        self.mem_mgmt_ctrl_operations = value;
...
impl<'lt> VideoEncodeH264ProfileEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH264ProfileEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> VideoEncodeH264NaluSliceEXT<'lt> {
    ...
    pub fn slice_header_std(&self) -> *const StdVideoEncodeH264SliceHeader {
    ...
    ///Sets the value of [`Self::mb_count`]
    ...
    ///Sets the value of [`Self::slice_header_std`]
    pub fn set_slice_header_std(&mut self, value: *const crate::native::StdVideoEncodeH264SliceHeader) -> &mut Self {
        self.slice_header_std = value;
        self
    }
    ///Sets the value of [`Self::s_type`]
    pub fn with_s_type(mut self, value: crate::vulkan1_0::StructureType) -> Self {
    ...
    ///Sets the value of [`Self::mb_count`]
    pub fn with_mb_count(mut self, value: u32) -> Self {
        self.mb_count = value;
        self
    }
    ///Sets the value of [`Self::reference_final_lists`]
    ...
    ///Sets the value of [`Self::slice_header_std`]
    pub fn with_slice_header_std(mut self, value: *const crate::native::StdVideoEncodeH264SliceHeader) -> Self {
        self.slice_header_std = value;
        self
    }
}
...
impl<'lt> VideoEncodeH264RateControlInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH264RateControlInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    pub fn set_rate_control_structure(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264RateControlStructureFlagBitsEXT,
    ) -> &mut Self {
        self.rate_control_structure = value;
        self
    }
    ///Sets the value of [`Self::temporal_layer_count`]
    ...
    ///Sets the value of [`Self::temporal_layer_count`]
    pub fn with_temporal_layer_count(mut self, value: u8) -> Self {
        self.temporal_layer_count = value;
        self
    }
}
...
impl<'lt> VideoEncodeH264RateControlLayerInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH264RateControlLayerInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::temporal_layer_id`]
    ...
    pub fn set_initial_rc_qp(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT,
    ) -> &mut Self {
    ...
    pub fn set_min_qp(&mut self, value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT) -> &mut Self {
        self.min_qp = value;
        self
    }
    ...
    pub fn set_max_qp(&mut self, value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT) -> &mut Self {
        self.max_qp = value;
        self
    }
    ...
    pub fn set_max_frame_size(
        &mut self,
        value: crate::extensions::ext_video_encode_h264::VideoEncodeH264FrameSizeEXT,
    ) -> &mut Self {
    ...
    ///Sets the value of [`Self::temporal_layer_id`]
    pub fn with_temporal_layer_id(mut self, value: u8) -> Self {
        self.temporal_layer_id = value;
        self
    }
    ///Sets the value of [`Self::use_initial_rc_qp`]
    ...
    ///Sets the value of [`Self::initial_rc_qp`]
    pub fn with_initial_rc_qp(mut self, value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT) -> Self {
        self.initial_rc_qp = value;
        self
    }
    ///Sets the value of [`Self::use_min_qp`]
    ...
    ///Sets the value of [`Self::min_qp`]
    pub fn with_min_qp(mut self, value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT) -> Self {
        self.min_qp = value;
        self
    }
    ///Sets the value of [`Self::use_max_qp`]
    ...
    ///Sets the value of [`Self::max_qp`]
    pub fn with_max_qp(mut self, value: crate::extensions::ext_video_encode_h264::VideoEncodeH264QpEXT) -> Self {
        self.max_qp = value;
        self
    }
    ///Sets the value of [`Self::use_max_frame_size`]
