...
impl std::fmt::Debug for CoverageReductionModeNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(CoverageReductionModeNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == CoverageReductionModeNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        CoverageReductionModeNV::MERGE => f.write_str("MERGE")?,
                        CoverageReductionModeNV::TRUNCATE => f.write_str("TRUNCATE")?,
...
impl<'lt> PhysicalDeviceCoverageReductionModeFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceCoverageReductionModeFeaturesNV<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::coverage_reduction_mode`]
    pub fn with_coverage_reduction_mode_raw(mut self, value: Bool32) -> Self {
        self.coverage_reduction_mode = value;
        self
    }
    ...
    ///Sets the value of [`Self::coverage_reduction_mode`]
    pub fn with_coverage_reduction_mode(mut self, value: bool) -> Self {
        self.coverage_reduction_mode = value as u8 as u32;
        self
    }
}
...
impl<'lt> PipelineCoverageReductionStateCreateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineCoverageReductionStateCreateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::coverage_reduction_mode`]
    pub fn with_coverage_reduction_mode(
        mut self,
        value: crate::extensions::nv_coverage_reduction_mode::CoverageReductionModeNV,
    ) -> Self {
        self.coverage_reduction_mode = value;
...
impl<'lt> FramebufferMixedSamplesCombinationNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> FramebufferMixedSamplesCombinationNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::depth_stencil_samples`]
    pub fn with_depth_stencil_samples(mut self, value: crate::vulkan1_0::SampleCountFlags) -> Self {
        self.depth_stencil_samples = value;
        self
    }
    ///Sets the value of [`Self::color_samples`]
    pub fn with_color_samples(mut self, value: crate::vulkan1_0::SampleCountFlags) -> Self {
        self.color_samples = value;
        self
    }
}
impl PhysicalDevice {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_physical_device_supported_framebuffer_mixed_samples_combinations_nv<'lt>(
