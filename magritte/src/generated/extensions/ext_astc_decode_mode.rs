...
impl<'lt> ImageViewAstcDecodeModeEXT<'lt> {
    ...
    pub fn set_decode_mode(mut self, value: crate::vulkan1_0::Format) -> Self {
...
impl<'lt> PhysicalDeviceAstcDecodeFeaturesEXT<'lt> {
    ...
    pub fn set_decode_mode_shared_exponent_raw(mut self, value: Bool32) -> Self {
    ...
    pub fn set_decode_mode_shared_exponent(mut self, value: bool) -> Self {
