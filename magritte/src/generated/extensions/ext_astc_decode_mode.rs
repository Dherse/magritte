...
impl<'lt> ImageViewAstcDecodeModeEXT<'lt> {
    ...
    pub fn make_static(mut self) -> ImageViewAstcDecodeModeEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::decode_mode`]
    ...
    ///Sets the value of [`Self::decode_mode`]
    pub fn with_decode_mode(mut self, value: crate::vulkan1_0::Format) -> Self {
        self.decode_mode = value;
        self
    }
}
...
impl<'lt> PhysicalDeviceAstcDecodeFeaturesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceAstcDecodeFeaturesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::decode_mode_shared_exponent`]
    pub fn with_decode_mode_shared_exponent_raw(mut self, value: Bool32) -> Self {
        self.decode_mode_shared_exponent = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::decode_mode_shared_exponent`]
    ...
    ///Sets the value of [`Self::decode_mode_shared_exponent`]
    pub fn with_decode_mode_shared_exponent(mut self, value: bool) -> Self {
        self.decode_mode_shared_exponent = value as u8 as u32;
        self
    }
}
