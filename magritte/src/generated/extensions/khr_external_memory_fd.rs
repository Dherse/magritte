...
impl<'lt> ImportMemoryFdInfoKHR<'lt> {
    ...
    pub fn make_static(mut self) -> ImportMemoryFdInfoKHR<'static> {
        unsafe {
...
impl<'lt> MemoryFdPropertiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryFdPropertiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> MemoryGetFdInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryGetFdInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    pub unsafe fn get_memory_fd_properties_khr<'lt>(
    ...
    ) -> VulkanResult<MemoryFdPropertiesKHR<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .khr_external_memory_fd()
        ...
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                ...
                std::mem::transmute(p_memory_fd_properties)
            }),
            e => VulkanResult::Err(e),
        }
    }
