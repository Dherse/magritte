...
impl std::fmt::Debug for LineRasterizationModeEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(LineRasterizationModeEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == LineRasterizationModeEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        LineRasterizationModeEXT::DEFAULT => f.write_str("DEFAULT")?,
                        LineRasterizationModeEXT::RECTANGULAR => f.write_str("RECTANGULAR")?,
                        LineRasterizationModeEXT::BRESENHAM => f.write_str("BRESENHAM")?,
                        LineRasterizationModeEXT::RECTANGULAR_SMOOTH => f.write_str("RECTANGULAR_SMOOTH")?,
...
impl<'lt> PhysicalDeviceLineRasterizationFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceLineRasterizationFeaturesEXT<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceLineRasterizationPropertiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceLineRasterizationPropertiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PipelineRasterizationLineStateCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineRasterizationLineStateCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
