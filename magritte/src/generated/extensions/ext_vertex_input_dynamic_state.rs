...
impl<'lt> PhysicalDeviceVertexInputDynamicStateFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceVertexInputDynamicStateFeaturesEXT<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::vertex_input_dynamic_state`]
    pub fn with_vertex_input_dynamic_state_raw(mut self, value: Bool32) -> Self {
        self.vertex_input_dynamic_state = value;
        self
    }
    ...
    ///Sets the value of [`Self::vertex_input_dynamic_state`]
    pub fn with_vertex_input_dynamic_state(mut self, value: bool) -> Self {
        self.vertex_input_dynamic_state = value as u8 as u32;
        self
    }
}
...
impl<'lt> VertexInputBindingDescription2EXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VertexInputBindingDescription2EXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::input_rate`]
    pub fn with_input_rate(mut self, value: crate::vulkan1_0::VertexInputRate) -> Self {
        self.input_rate = value;
        self
    }
    ///Sets the value of [`Self::divisor`]
...
impl<'lt> VertexInputAttributeDescription2EXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VertexInputAttributeDescription2EXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl CommandBuffer {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn cmd_set_vertex_input_ext<'lt>(
