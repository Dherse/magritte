...
//!priority.
//!The default queue priority is `VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT`.The driver implementation
//! will attempt to skew hardware resource allocation
...
//! * 2017-10-06
//! * No known IP claims.
//! * - Andres Rodriguez, Valve  - Pierre-Loup Griffais, Valve  - Dan Ginsburg, Valve  - Mitch
//!   Singer, AMD
//!# Related
...
pub const EXT_GLOBAL_PRIORITY_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_EXT_global_priority");
