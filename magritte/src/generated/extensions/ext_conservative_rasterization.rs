...
impl<'lt> PhysicalDeviceConservativeRasterizationPropertiesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceConservativeRasterizationPropertiesEXT<'static> {
        unsafe {
...
impl<'lt> PipelineRasterizationConservativeStateCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineRasterizationConservativeStateCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
