...
impl<'lt> Default for PhysicalDeviceShaderImageAtomicInt64FeaturesEXT<'lt> {
    fn default() -> Self {
        Self {
            ...
            shader_image_int64_atomics: 0,
            sparse_image_int64_atomics: 0,
        }
    }
}
impl<'lt> PhysicalDeviceShaderImageAtomicInt64FeaturesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceShaderImageAtomicInt64FeaturesEXT<'static> {
        unsafe {
    ...
    ///Gets the raw value of [`Self::shader_image_int64_atomics`]
    pub fn shader_image_int64_atomics_raw(&self) -> Bool32 {
        self.shader_image_int64_atomics
    }
    ///Gets the raw value of [`Self::sparse_image_int64_atomics`]
    pub fn sparse_image_int64_atomics_raw(&self) -> Bool32 {
    ...
    ///Sets the raw value of [`Self::shader_image_int64_atomics`]
    pub fn set_shader_image_int64_atomics_raw(&mut self, value: Bool32) -> &mut Self {
        self.shader_image_int64_atomics = value;
        self
    }
    ///Sets the raw value of [`Self::sparse_image_int64_atomics`]
    pub fn set_sparse_image_int64_atomics_raw(&mut self, value: Bool32) -> &mut Self {
    ...
    ///Sets the raw value of [`Self::shader_image_int64_atomics`]
    pub fn with_shader_image_int64_atomics_raw(mut self, value: Bool32) -> Self {
        self.shader_image_int64_atomics = value;
        self
    }
    ///Sets the raw value of [`Self::sparse_image_int64_atomics`]
    pub fn with_sparse_image_int64_atomics_raw(mut self, value: Bool32) -> Self {
        self.sparse_image_int64_atomics = value;
        self
    }
    ...
    ///Gets the value of [`Self::shader_image_int64_atomics`]
    pub fn shader_image_int64_atomics(&self) -> bool {
        unsafe { std::mem::transmute(self.shader_image_int64_atomics as u8) }
    }
    ///Gets the value of [`Self::sparse_image_int64_atomics`]
    pub fn sparse_image_int64_atomics(&self) -> bool {
        unsafe { std::mem::transmute(self.sparse_image_int64_atomics as u8) }
    }
    ...
    ///Gets a mutable reference to the value of [`Self::shader_image_int64_atomics`]
    pub fn shader_image_int64_atomics_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.shader_image_int64_atomics as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Gets a mutable reference to the value of [`Self::sparse_image_int64_atomics`]
    pub fn sparse_image_int64_atomics_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.sparse_image_int64_atomics as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Sets the value of [`Self::shader_image_int64_atomics`]
    pub fn set_shader_image_int64_atomics(&mut self, value: bool) -> &mut Self {
        self.shader_image_int64_atomics = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::sparse_image_int64_atomics`]
    pub fn set_sparse_image_int64_atomics(&mut self, value: bool) -> &mut Self {
        self.sparse_image_int64_atomics = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::shader_image_int64_atomics`]
    pub fn with_shader_image_int64_atomics(mut self, value: bool) -> Self {
        self.shader_image_int64_atomics = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::sparse_image_int64_atomics`]
    pub fn with_sparse_image_int64_atomics(mut self, value: bool) -> Self {
        self.sparse_image_int64_atomics = value as u8 as u32;
        self
    }
}
