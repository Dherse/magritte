...
impl<'lt> ImportMemoryBufferCollectionFUCHSIA<'lt> {
    ...
    pub fn make_static(mut self) -> ImportMemoryBufferCollectionFUCHSIA<'static> {
        unsafe {
...
impl<'lt> BufferCollectionImageCreateInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferCollectionImageCreateInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> BufferCollectionBufferCreateInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferCollectionBufferCreateInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> BufferCollectionCreateInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferCollectionCreateInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> BufferCollectionPropertiesFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferCollectionPropertiesFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> BufferConstraintsInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferConstraintsInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> SysmemColorSpaceFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> SysmemColorSpaceFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> BufferCollectionConstraintsInfoFUCHSIA<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BufferCollectionConstraintsInfoFUCHSIA<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    ) -> VulkanResult<BufferCollectionPropertiesFUCHSIA<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .fuchsia_buffer_collection()
