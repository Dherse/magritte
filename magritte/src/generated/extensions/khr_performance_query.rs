...
impl std::fmt::Debug for PerformanceCounterScopeKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceCounterScopeKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceCounterScopeKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceCounterScopeKHR::COMMAND_BUFFER => f.write_str("COMMAND_BUFFER")?,
                        PerformanceCounterScopeKHR::RENDER_PASS => f.write_str("RENDER_PASS")?,
                        PerformanceCounterScopeKHR::COMMAND => f.write_str("COMMAND")?,
...
impl std::fmt::Debug for PerformanceCounterUnitKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceCounterUnitKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceCounterUnitKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceCounterUnitKHR::GENERIC => f.write_str("GENERIC")?,
                        PerformanceCounterUnitKHR::PERCENTAGE => f.write_str("PERCENTAGE")?,
                        PerformanceCounterUnitKHR::NANOSECONDS => f.write_str("NANOSECONDS")?,
                        PerformanceCounterUnitKHR::BYTES => f.write_str("BYTES")?,
                        PerformanceCounterUnitKHR::BYTES_PER_SECOND => f.write_str("BYTES_PER_SECOND")?,
                        PerformanceCounterUnitKHR::KELVIN => f.write_str("KELVIN")?,
                        PerformanceCounterUnitKHR::WATTS => f.write_str("WATTS")?,
                        PerformanceCounterUnitKHR::VOLTS => f.write_str("VOLTS")?,
                        PerformanceCounterUnitKHR::AMPS => f.write_str("AMPS")?,
                        PerformanceCounterUnitKHR::HERTZ => f.write_str("HERTZ")?,
                        PerformanceCounterUnitKHR::CYCLES => f.write_str("CYCLES")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for PerformanceCounterStorageKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceCounterStorageKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceCounterStorageKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceCounterStorageKHR::INT32 => f.write_str("INT32")?,
                        PerformanceCounterStorageKHR::INT64 => f.write_str("INT64")?,
                        PerformanceCounterStorageKHR::UINT32 => f.write_str("UINT32")?,
                        PerformanceCounterStorageKHR::UINT64 => f.write_str("UINT64")?,
                        PerformanceCounterStorageKHR::FLOAT32 => f.write_str("FLOAT32")?,
                        PerformanceCounterStorageKHR::FLOAT64 => f.write_str("FLOAT64")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for PerformanceCounterDescriptionFlagBitsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceCounterDescriptionFlagBitsKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceCounterDescriptionFlagBitsKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceCounterDescriptionFlagBitsKHR::PERFORMANCE_IMPACTING => {
                            f.write_str("PERFORMANCE_IMPACTING")?
                        },
                        PerformanceCounterDescriptionFlagBitsKHR::CONCURRENTLY_IMPACTED => {
...
impl std::fmt::Debug for AcquireProfilingLockFlagBitsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(AcquireProfilingLockFlagBitsKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == AcquireProfilingLockFlagBitsKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        _ => f.write_str("invalid")?,
...
impl<'lt> PhysicalDevicePerformanceQueryFeaturesKHR<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDevicePerformanceQueryFeaturesKHR<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::performance_counter_query_pools`]
    pub fn with_performance_counter_query_pools_raw(mut self, value: Bool32) -> Self {
        self.performance_counter_query_pools = value;
        self
    }
    ///Sets the raw value of [`Self::performance_counter_multiple_query_pools`]
    pub fn with_performance_counter_multiple_query_pools_raw(mut self, value: Bool32) -> Self {
        self.performance_counter_multiple_query_pools = value;
        self
    }
    ...
    ///Sets the value of [`Self::performance_counter_query_pools`]
    pub fn with_performance_counter_query_pools(mut self, value: bool) -> Self {
        self.performance_counter_query_pools = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::performance_counter_multiple_query_pools`]
    pub fn with_performance_counter_multiple_query_pools(mut self, value: bool) -> Self {
        self.performance_counter_multiple_query_pools = value as u8 as u32;
        self
    }
}
...
impl<'lt> PhysicalDevicePerformanceQueryPropertiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDevicePerformanceQueryPropertiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::allow_command_buffer_query_copies`]
    pub fn with_allow_command_buffer_query_copies_raw(mut self, value: Bool32) -> Self {
        self.allow_command_buffer_query_copies = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::allow_command_buffer_query_copies`]
    pub fn with_allow_command_buffer_query_copies(mut self, value: bool) -> Self {
        self.allow_command_buffer_query_copies = value as u8 as u32;
        self
    }
}
...
impl<'lt> PerformanceCounterKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceCounterKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::unit`]
    pub fn with_unit(mut self, value: crate::extensions::khr_performance_query::PerformanceCounterUnitKHR) -> Self {
        self.unit = value;
        self
    }
    ///Sets the value of [`Self::scope`]
    pub fn with_scope(mut self, value: crate::extensions::khr_performance_query::PerformanceCounterScopeKHR) -> Self {
        self.scope = value;
        self
    }
    ///Sets the value of [`Self::storage`]
    ...
    ///Sets the value of [`Self::uuid`]
    pub fn with_uuid(mut self, value: [u8; crate::core::UUID_SIZE as usize]) -> Self {
        self.uuid = value;
        self
    }
}
...
impl<'lt> PerformanceCounterDescriptionKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceCounterDescriptionKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::name`]
    pub fn with_name(mut self, value: [std::os::raw::c_char; crate::core::MAX_DESCRIPTION_SIZE as usize]) -> Self {
        self.name = value;
        self
    }
    ///Sets the value of [`Self::category`]
    pub fn with_category(mut self, value: [std::os::raw::c_char; crate::core::MAX_DESCRIPTION_SIZE as usize]) -> Self {
        self.category = value;
        self
    }
    ///Sets the value of [`Self::description`]
...
impl<'lt> QueryPoolPerformanceCreateInfoKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::counter_indices`]
    pub fn with_counter_indices_raw(mut self, value: *const u32) -> Self {
        self.counter_indices = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::counter_index_count`]
    pub fn with_counter_index_count(mut self, value: u32) -> Self {
        self.counter_index_count = value;
        self
    }
    ///Sets the value of [`Self::counter_indices`]
    pub fn with_counter_indices(mut self, value: &'lt [u32]) -> Self {
        let len_ = value.len() as u32;
        let len_ = len_;
        self.counter_indices = value.as_ptr();
        self.counter_index_count = len_;
...
impl<'lt> AcquireProfilingLockInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> AcquireProfilingLockInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::khr_performance_query::AcquireProfilingLockFlagsKHR) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::timeout`]
...
impl<'lt> PerformanceQuerySubmitInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceQuerySubmitInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::counter_pass_index`]
    pub fn with_counter_pass_index(mut self, value: u32) -> Self {
        self.counter_pass_index = value;
        self
    }
}
...
impl PhysicalDevice {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn enumerate_physical_device_queue_family_performance_query_counters_khr<'lt>(
...
impl PhysicalDevice {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_physical_device_queue_family_performance_query_passes_khr<'lt>(
        self: &Unique<PhysicalDevice>,
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn acquire_profiling_lock_khr<'lt>(
        self: &Unique<Device>,
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn release_profiling_lock_khr(self: &Unique<Device>) -> () {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .khr_performance_query()
