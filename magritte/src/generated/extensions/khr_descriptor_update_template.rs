        ...
        F: Fn(Device, &'static CStr) -> Option<extern "system" fn()>,
    {
        Self {
            cmd_push_descriptor_set_with_template_khr: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkCmdPushDescriptorSetWithTemplateKHR")))
            },
            create_descriptor_update_template: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkCreateDescriptorUpdateTemplateKHR")))
            },
            destroy_descriptor_update_template: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkDestroyDescriptorUpdateTemplateKHR")))
            },
            update_descriptor_set_with_template: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkUpdateDescriptorSetWithTemplateKHR")))
            },
        }
    }
