...
impl<'lt> PhysicalDeviceDepthClipEnableFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceDepthClipEnableFeaturesEXT<'static> {
        unsafe {
...
impl<'lt> PipelineRasterizationDepthClipStateCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineRasterizationDepthClipStateCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
