...
impl<'lt> AndroidSurfaceCreateInfoKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::window`]
    pub fn with_window_raw(mut self, value: *mut ANativeWindow) -> Self {
        self.window = value;
        self
    }
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::khr_android_surface::AndroidSurfaceCreateFlagsKHR) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::window`]
    pub fn with_window(mut self, value: &'lt mut crate::extensions::khr_android_surface::ANativeWindow) -> Self {
        self.window = value as *mut _;
        self
    }
}
