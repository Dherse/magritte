...
/// - [`p_get_win32_handle_info`] is a pointer to a [`MemoryGetWin32HandleInfoKHR`] structure
...
pub type FNGetMemoryWin32HandleKhr = Option<
    for<'lt> unsafe extern "system" fn(
        device: Device,
        p_get_win32_handle_info: *const MemoryGetWin32HandleInfoKHR<'lt>,
        p_handle: *mut HANDLE,
    ) -> VulkanResultCodes,
>;
...
/// - [`p_memory_win32_handle_properties`] is a pointer to a [`MemoryWin32HandlePropertiesKHR`]
...
/// - [`p_memory_win32_handle_properties`] **must**  be a valid pointer to a
...
pub type FNGetMemoryWin32HandlePropertiesKhr = Option<
    for<'lt> unsafe extern "system" fn(
        ...
        handle: HANDLE,
        p_memory_win32_handle_properties: *mut MemoryWin32HandlePropertiesKHR<'lt>,
    ) -> VulkanResultCodes,
>;
...
impl<'lt> ImportMemoryWin32HandleInfoKHR<'lt> {
    ...
    pub fn make_static(mut self) -> ImportMemoryWin32HandleInfoKHR<'static> {
        unsafe {
...
impl<'lt> MemoryWin32HandlePropertiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryWin32HandlePropertiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> MemoryGetWin32HandleInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> MemoryGetWin32HandleInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_memory_win32_handle_khr<'lt>(
        self: &Unique<Device>,
        p_get_win32_handle_info: &MemoryGetWin32HandleInfoKHR<'lt>,
    ) -> VulkanResult<HANDLE> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .khr_external_memory_win32()
            .and_then(|vtable| vtable.get_memory_win32_handle_khr())
        ...
        let _return = _function(
            self.as_raw(),
            p_get_win32_handle_info as *const MemoryGetWin32HandleInfoKHR<'lt>,
            &mut p_handle,
        );
        match _return {
...
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_memory_win32_handle_properties_khr<'lt>(
        self: &Unique<Device>,
        handle_type: ExternalMemoryHandleTypeFlagBits,
        handle: HANDLE,
        p_memory_win32_handle_properties: Option<MemoryWin32HandlePropertiesKHR<'lt>>,
    ) -> VulkanResult<MemoryWin32HandlePropertiesKHR<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .khr_external_memory_win32()
            .and_then(|vtable| vtable.get_memory_win32_handle_properties_khr())
            .expect("function not loaded");
        #[cfg(not(any(debug_assertions, feature = "assertions")))]
        let _function = self
            .vtable()
            ...
            .and_then(|vtable| vtable.get_memory_win32_handle_properties_khr())
            .unwrap_unchecked();
        let mut p_memory_win32_handle_properties = p_memory_win32_handle_properties.unwrap_or_default();
        let _return = _function(
            self.as_raw(),
            handle_type,
            handle,
            &mut p_memory_win32_handle_properties,
        );
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                p_memory_win32_handle_properties.p_next = std::ptr::null_mut();
                std::mem::transmute(p_memory_win32_handle_properties)
            }),
            e => VulkanResult::Err(e),
        }
    }
    ...
    pub fn load(
        ...
        Self {
            get_memory_win32_handle_khr: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkGetMemoryWin32HandleKHR").as_ptr()))
            },
            get_memory_win32_handle_properties_khr: unsafe {
                std::mem::transmute(loader_fn(
                    loader,
                    crate::cstr!("vkGetMemoryWin32HandlePropertiesKHR").as_ptr(),
                ))
            },
        }
    }
