...
impl<'lt> CuFunctionCreateInfoNVX<'lt> {
    ...
    pub fn make_static(mut self) -> CuFunctionCreateInfoNVX<'static> {
        unsafe {
...
impl CuModuleNVX {
    ...
    pub fn set_name(self: &Unique<Self>, name: &std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_utils::DebugUtilsObjectNameInfoEXT::default()
            .with_object_type(crate::generated::vulkan1_0::ObjectType::CU_MODULE_NVX)
...
impl CuFunctionNVX {
    ...
    pub fn set_name(self: &Unique<Self>, name: &std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_utils::DebugUtilsObjectNameInfoEXT::default()
            .with_object_type(crate::generated::vulkan1_0::ObjectType::CU_FUNCTION_NVX)
            .with_object_handle(self.as_stored() as u64)
            .with_object_name(name.as_ptr());
        unsafe {
            self.device().set_debug_utils_object_name_ext(&info).unwrap();
