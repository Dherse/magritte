...
//!might be better off just using the general path for all invocations.This extension provides the
...
//!   - This extension provides API support for [`GL_ARB_shader_group_vote`](https://www.khronos.org/registry/OpenGL/extensions/ARB/ARB_shader_group_vote.txt)
...
pub const EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_EXT_shader_subgroup_vote");
