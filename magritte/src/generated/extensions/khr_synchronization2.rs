...
impl<'lt> QueueFamilyCheckpointProperties2NV<'lt> {
    ...
    pub fn make_static(mut self) -> QueueFamilyCheckpointProperties2NV<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::checkpoint_execution_stage_mask`]
    pub fn with_checkpoint_execution_stage_mask(mut self, value: crate::vulkan1_3::PipelineStageFlags2) -> Self {
        self.checkpoint_execution_stage_mask = value;
        self
    }
}
...
impl<'lt> CheckpointData2NV<'lt> {
    ...
    ///Sets the value of [`Self::stage`]
    pub fn with_stage(mut self, value: crate::vulkan1_3::PipelineStageFlags2) -> Self {
        self.stage = value;
        self
    }
    ///Sets the value of [`Self::checkpoint_marker`]
