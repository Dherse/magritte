...
impl<'lt> DrmFormatModifierPropertiesListEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::drm_format_modifier_properties`]
    pub fn with_drm_format_modifier_properties_raw(mut self, value: *mut DrmFormatModifierPropertiesEXT) -> Self {
        self.drm_format_modifier_properties = value;
        self
    }
    ...
    ///Sets the value of [`Self::drm_format_modifier_count`]
    pub fn with_drm_format_modifier_count(mut self, value: u32) -> Self {
        self.drm_format_modifier_count = value;
        self
    }
    ///Sets the value of [`Self::drm_format_modifier_properties`]
    pub fn with_drm_format_modifier_properties(
        mut self,
        value: &'lt mut [crate::extensions::ext_image_drm_format_modifier::DrmFormatModifierPropertiesEXT],
    ) -> Self {
        let len_ = value.len() as u32;
...
impl DrmFormatModifierPropertiesEXT {
    ...
    ///Sets the value of [`Self::drm_format_modifier`]
    pub fn with_drm_format_modifier(mut self, value: u64) -> Self {
        self.drm_format_modifier = value;
        self
    }
    ///Sets the value of [`Self::drm_format_modifier_plane_count`]
    pub fn with_drm_format_modifier_plane_count(mut self, value: u32) -> Self {
        self.drm_format_modifier_plane_count = value;
        self
    }
    ///Sets the value of [`Self::drm_format_modifier_tiling_features`]
    pub fn with_drm_format_modifier_tiling_features(mut self, value: crate::vulkan1_0::FormatFeatureFlags) -> Self {
        self.drm_format_modifier_tiling_features = value;
        self
    }
}
...
impl<'lt> PhysicalDeviceImageDrmFormatModifierInfoEXT<'lt> {
    ...
    ///Sets the value of [`Self::sharing_mode`]
    pub fn with_sharing_mode(mut self, value: crate::vulkan1_0::SharingMode) -> Self {
        self.sharing_mode = value;
        self
    }
    ///Sets the value of [`Self::queue_family_index_count`]
...
impl<'lt> ImageDrmFormatModifierListCreateInfoEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::drm_format_modifiers`]
    pub fn with_drm_format_modifiers_raw(mut self, value: *const u64) -> Self {
        self.drm_format_modifiers = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::drm_format_modifiers`]
    pub fn with_drm_format_modifiers(mut self, value: &'lt [u64]) -> Self {
        let len_ = value.len() as u32;
        let len_ = len_;
        self.drm_format_modifiers = value.as_ptr();
        self.drm_format_modifier_count = len_;
...
impl<'lt> ImageDrmFormatModifierExplicitCreateInfoEXT<'lt> {
    ...
    ///Sets the raw value of [`Self::plane_layouts`]
    pub fn with_plane_layouts_raw(mut self, value: *const SubresourceLayout) -> Self {
        self.plane_layouts = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::plane_layouts`]
    pub fn with_plane_layouts(mut self, value: &'lt [crate::vulkan1_0::SubresourceLayout]) -> Self {
        let len_ = value.len() as u32;
        let len_ = len_;
        self.plane_layouts = value.as_ptr();
        self.drm_format_modifier_plane_count = len_;
...
impl<'lt> ImageDrmFormatModifierPropertiesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> ImageDrmFormatModifierPropertiesEXT<'static> {
        unsafe {
...
impl<'lt> DrmFormatModifierPropertiesList2EXT<'lt> {
    ...
    ///Sets the raw value of [`Self::drm_format_modifier_properties`]
    pub fn with_drm_format_modifier_properties_raw(mut self, value: *mut DrmFormatModifierProperties2EXT) -> Self {
        self.drm_format_modifier_properties = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
...
impl DrmFormatModifierProperties2EXT {
    ...
    ///Sets the value of [`Self::drm_format_modifier_tiling_features`]
    pub fn with_drm_format_modifier_tiling_features(mut self, value: crate::vulkan1_3::FormatFeatureFlags2) -> Self {
        self.drm_format_modifier_tiling_features = value;
        self
    }
}
impl Device {
    ...
    #[track_caller]
    #[inline]
    pub unsafe fn get_image_drm_format_modifier_properties_ext<'lt>(
        self: &Unique<Device>,
        image: Image,
        p_properties: Option<ImageDrmFormatModifierPropertiesEXT<'lt>>,
    ) -> VulkanResult<ImageDrmFormatModifierPropertiesEXT<'static>> {
