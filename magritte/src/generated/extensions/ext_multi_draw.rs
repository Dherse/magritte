...
use crate::vulkan1_0::{BaseOutStructure, Bool32, CommandBuffer, Device, StructureType};
...
impl DeviceExtMultiDrawVTable {
    ...
    {
        Self {
            cmd_draw_multi_ext: unsafe { std::mem::transmute(loader_fn(loader, crate::cstr!("vkCmdDrawMultiEXT"))) },
            cmd_draw_multi_indexed_ext: unsafe {
                std::mem::transmute(loader_fn(loader, crate::cstr!("vkCmdDrawMultiIndexedEXT")))
            },
        }
    }
