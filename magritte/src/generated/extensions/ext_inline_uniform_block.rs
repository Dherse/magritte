...
//!or dwords for inline uniform block descriptors?**RESOLVED**: In bytes, but both **must** be a
//! multiple of 4, similar to how push
...
//!by [`VK_EXT_descriptor_indexing`] supported for inline uniform blocks?**RESOLVED**: Yes, as long
//! as other inline uniform block specific limits are
