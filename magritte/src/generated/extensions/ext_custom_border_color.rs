...
//! - `VK_BORDER_COLOR_INT_CUSTOM_EXT`When `VK_BORDER_COLOR_FLOAT_CUSTOM_EXT` or
...
//!used here because it provides a union of float,int,uint types.**RESOLVED**: Will reuse existing
//! VkClearColorValue structure in order to
