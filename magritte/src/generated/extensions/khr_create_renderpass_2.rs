...
//!follows:
//! - Elements of [`RenderPassMultiviewCreateInfo::p_view_masks`] are
//!now specified in [`SubpassDescription2KHR::view_mask`].
//! - Elements of [`RenderPassMultiviewCreateInfo::p_view_offsets`]
//!are now specified in [`SubpassDependency2KHR::view_offset`].
//! - [`RenderPassMultiviewCreateInfo::correlation_mask_count`] and
//![`RenderPassMultiviewCreateInfo::p_correlation_masks`] are
