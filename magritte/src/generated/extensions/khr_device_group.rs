...
use crate::{
    ...
    vulkan1_1::{FNCmdDispatchBase, FNCmdSetDeviceMask, FNGetDeviceGroupPeerMemoryFeatures},
...
impl std::fmt::Debug for DeviceGroupPresentModeFlagBitsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DeviceGroupPresentModeFlagBitsKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DeviceGroupPresentModeFlagBitsKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        #[cfg(feature = "VK_KHR_swapchain")]
                        DeviceGroupPresentModeFlagBitsKHR::LOCAL => f.write_str("LOCAL")?,
                        #[cfg(feature = "VK_KHR_swapchain")]
                        DeviceGroupPresentModeFlagBitsKHR::REMOTE => f.write_str("REMOTE")?,
                        #[cfg(feature = "VK_KHR_swapchain")]
                        DeviceGroupPresentModeFlagBitsKHR::SUM => f.write_str("SUM")?,
                        #[cfg(feature = "VK_KHR_swapchain")]
                        DeviceGroupPresentModeFlagBitsKHR::LOCAL_MULTI_DEVICE => f.write_str("LOCAL_MULTI_DEVICE")?,
...
impl<'lt> DeviceGroupPresentCapabilitiesKHR<'lt> {
    ...
    pub fn make_static(mut self) -> DeviceGroupPresentCapabilitiesKHR<'static> {
        unsafe {
    ...
    pub fn set_present_mask(&mut self, value: [u32; crate::core::MAX_DEVICE_GROUP_SIZE as usize]) -> &mut Self {
    ...
    ///Sets the value of [`Self::present_mask`]
    pub fn with_present_mask(mut self, value: [u32; crate::core::MAX_DEVICE_GROUP_SIZE as usize]) -> Self {
        self.present_mask = value;
        self
    }
    ///Sets the value of [`Self::modes`]
    pub fn with_modes(mut self, value: crate::extensions::khr_device_group::DeviceGroupPresentModeFlagsKHR) -> Self {
        self.modes = value;
        self
    }
}
...
impl<'lt> ImageSwapchainCreateInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> ImageSwapchainCreateInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::swapchain`]
    pub fn with_swapchain(mut self, value: crate::extensions::khr_swapchain::SwapchainKHR) -> Self {
        self.swapchain = value;
        self
    }
}
...
impl<'lt> BindImageMemorySwapchainInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> BindImageMemorySwapchainInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::image_index`]
    pub fn with_image_index(mut self, value: u32) -> Self {
        self.image_index = value;
        self
    }
}
...
impl<'lt> AcquireNextImageInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> AcquireNextImageInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> DeviceGroupPresentInfoKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::device_masks`]
    pub fn with_device_masks_raw(mut self, value: *const u32) -> Self {
        self.device_masks = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::device_masks`]
    pub fn with_device_masks(mut self, value: &'lt [u32]) -> Self {
        let len_ = value.len() as u32;
        let len_ = len_;
        self.device_masks = value.as_ptr();
        self.swapchain_count = len_;
    ...
    ///Sets the value of [`Self::mode`]
    pub fn with_mode(mut self, value: crate::extensions::khr_device_group::DeviceGroupPresentModeFlagBitsKHR) -> Self {
        self.mode = value;
        self
    }
}
...
impl<'lt> DeviceGroupSwapchainCreateInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DeviceGroupSwapchainCreateInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    pub unsafe fn get_device_group_present_capabilities_khr<'lt>(
    ...
    ) -> VulkanResult<DeviceGroupPresentCapabilitiesKHR<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .khr_device_group()
        ...
        match _return {
            VulkanResultCodes::SUCCESS => VulkanResult::Success(_return, {
                ...
                std::mem::transmute(p_device_group_present_capabilities)
            }),
            e => VulkanResult::Err(e),
        }
    }
