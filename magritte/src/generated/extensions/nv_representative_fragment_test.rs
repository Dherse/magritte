...
impl<'lt> PhysicalDeviceRepresentativeFragmentTestFeaturesNV<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceRepresentativeFragmentTestFeaturesNV<'static> {
        unsafe {
...
impl<'lt> PipelineRepresentativeFragmentTestStateCreateInfoNV<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineRepresentativeFragmentTestStateCreateInfoNV<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
