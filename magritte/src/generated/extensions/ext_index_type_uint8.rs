...
pub struct PhysicalDeviceIndexTypeUint8FeaturesEXT<'lt> {
    ...
    ///[`index_type_uint8`] indicates that
...
impl<'lt> PhysicalDeviceIndexTypeUint8FeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceIndexTypeUint8FeaturesEXT<'static> {
        unsafe {
    ...
    ///Gets the raw value of [`Self::index_type_uint8`]
    pub fn index_type_uint8_raw(&self) -> Bool32 {
    ...
    ///Sets the raw value of [`Self::index_type_uint8`]
    pub fn set_index_type_uint8_raw(&mut self, value: Bool32) -> &mut Self {
    ...
    ///Sets the raw value of [`Self::index_type_uint8`]
    pub fn with_index_type_uint8_raw(mut self, value: Bool32) -> Self {
        self.index_type_uint8 = value;
        self
    }
    ...
    ///Gets the value of [`Self::index_type_uint8`]
    pub fn index_type_uint8(&self) -> bool {
        unsafe { std::mem::transmute(self.index_type_uint8 as u8) }
    }
    ...
    ///Gets a mutable reference to the value of [`Self::index_type_uint8`]
    pub fn index_type_uint8_mut(&mut self) -> &mut bool {
        unsafe {
            if cfg!(target_endian = "little") {
                &mut *(self.index_type_uint8 as *mut Bool32)
                    .cast::<u32>()
                    .cast::<u8>()
                    .cast::<bool>()
            } else {
    ...
    ///Sets the value of [`Self::index_type_uint8`]
    pub fn set_index_type_uint8(&mut self, value: bool) -> &mut Self {
        self.index_type_uint8 = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::index_type_uint8`]
    pub fn with_index_type_uint8(mut self, value: bool) -> Self {
        self.index_type_uint8 = value as u8 as u32;
        self
    }
}
