...
impl<'lt> PhysicalDeviceFragmentDensityMapFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceFragmentDensityMapFeaturesEXT<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceFragmentDensityMapPropertiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceFragmentDensityMapPropertiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> RenderPassFragmentDensityMapCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> RenderPassFragmentDensityMapCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
