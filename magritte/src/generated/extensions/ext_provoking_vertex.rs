...
impl std::fmt::Debug for ProvokingVertexModeEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ProvokingVertexModeEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ProvokingVertexModeEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ProvokingVertexModeEXT::FIRST_VERTEX => f.write_str("FIRST_VERTEX")?,
                        ProvokingVertexModeEXT::LAST_VERTEX => f.write_str("LAST_VERTEX")?,
...
impl<'lt> PhysicalDeviceProvokingVertexFeaturesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> PhysicalDeviceProvokingVertexFeaturesEXT<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceProvokingVertexPropertiesEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceProvokingVertexPropertiesEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PipelineRasterizationProvokingVertexStateCreateInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PipelineRasterizationProvokingVertexStateCreateInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
