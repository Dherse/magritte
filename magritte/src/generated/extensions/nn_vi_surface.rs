...
impl<'lt> ViSurfaceCreateInfoNN<'lt> {
    ...
    pub fn set_window_raw(mut self, value: *mut c_void) -> Self {
        self.window = value;
        self
    }
    ...
    pub fn set_flags(mut self, value: crate::extensions::nn_vi_surface::ViSurfaceCreateFlagsNN) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::window`]
    pub fn set_window(mut self, value: &'lt mut std::ffi::c_void) -> Self {
