...
impl Device {
    ...
    pub unsafe fn get_memory_win32_handle_khr<'lt>(
        ...
        let _return = _function(
            self.as_raw(),
            p_get_win_32_handle_info as *const MemoryGetWin32HandleInfoKHR<'lt>,
            &mut p_handle,
        );
        match _return {
...
impl Device {
    ...
    pub unsafe fn get_memory_win32_handle_properties_khr<'lt>(
        ...
        let _function = self
            ...
            .and_then(|vtable| vtable.get_memory_win32_handle_properties_khr())
            .unwrap_unchecked();
        let mut p_memory_win_32_handle_properties = p_memory_win_32_handle_properties.unwrap_or_default();
        let _return = _function(
            self.as_raw(),
            handle_type,
            handle,
