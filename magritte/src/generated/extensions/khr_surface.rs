...
impl ColorSpaceKHR {
    ...
    pub const COLORSPACE_SRGB_NONLINEAR: Self = Self::VK_COLOR_SPACE_SRGB_NONLINEAR_KHR;
    ///No documentation found
    ///
    ///Provided by [`crate::extensions::ext_swapchain_colorspace`]
    pub const COLOR_SPACE_DCI_P3_LINEAR_EXT: Self = Self::VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT;
    ///Default empty value
    #[inline]
    pub const fn empty() -> Self {
        Self::default()
