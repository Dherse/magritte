...
impl std::fmt::Debug for PresentModeKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PresentModeKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PresentModeKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PresentModeKHR::IMMEDIATE => f.write_str("IMMEDIATE")?,
                        PresentModeKHR::MAILBOX => f.write_str("MAILBOX")?,
                        PresentModeKHR::FIFO => f.write_str("FIFO")?,
                        PresentModeKHR::FIFO_RELAXED => f.write_str("FIFO_RELAXED")?,
                        #[cfg(feature = "VK_KHR_shared_presentable_image")]
                        PresentModeKHR::SHARED_DEMAND_REFRESH => f.write_str("SHARED_DEMAND_REFRESH")?,
                        #[cfg(feature = "VK_KHR_shared_presentable_image")]
                        PresentModeKHR::SHARED_CONTINUOUS_REFRESH => f.write_str("SHARED_CONTINUOUS_REFRESH")?,
        ...
        f.debug_tuple(stringify!(PresentModeKHR)).field(&Flags(*self)).finish()
    }
}
...
impl std::fmt::Debug for ColorSpaceKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ColorSpaceKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ColorSpaceKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ColorSpaceKHR::SRGB_NONLINEAR => f.write_str("SRGB_NONLINEAR")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::DISPLAY_P3_NONLINEAR_EXT => f.write_str("DISPLAY_P3_NONLINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::EXTENDED_SRGB_LINEAR_EXT => f.write_str("EXTENDED_SRGB_LINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::DISPLAY_P3_LINEAR_EXT => f.write_str("DISPLAY_P3_LINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::DCI_P3_NONLINEAR_EXT => f.write_str("DCI_P3_NONLINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::BT709_LINEAR_EXT => f.write_str("BT709_LINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::BT709_NONLINEAR_EXT => f.write_str("BT709_NONLINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::BT2020_LINEAR_EXT => f.write_str("BT2020_LINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::HDR10_ST2084_EXT => f.write_str("HDR10_ST2084_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::DOLBYVISION_EXT => f.write_str("DOLBYVISION_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::HDR10_HLG_EXT => f.write_str("HDR10_HLG_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::ADOBERGB_LINEAR_EXT => f.write_str("ADOBERGB_LINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::ADOBERGB_NONLINEAR_EXT => f.write_str("ADOBERGB_NONLINEAR_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::PASS_THROUGH_EXT => f.write_str("PASS_THROUGH_EXT")?,
                        #[cfg(feature = "VK_EXT_swapchain_colorspace")]
                        ColorSpaceKHR::EXTENDED_SRGB_NONLINEAR_EXT => f.write_str("EXTENDED_SRGB_NONLINEAR_EXT")?,
                        #[cfg(feature = "VK_AMD_display_native_hdr")]
                        ColorSpaceKHR::DISPLAY_NATIVE_AMD => f.write_str("DISPLAY_NATIVE_AMD")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
        ...
        f.debug_tuple(stringify!(ColorSpaceKHR)).field(&Flags(*self)).finish()
    }
}
...
impl std::fmt::Debug for CompositeAlphaFlagBitsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(CompositeAlphaFlagBitsKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == CompositeAlphaFlagBitsKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        CompositeAlphaFlagBitsKHR::OPAQUE => f.write_str("OPAQUE")?,
                        CompositeAlphaFlagBitsKHR::PRE_MULTIPLIED => f.write_str("PRE_MULTIPLIED")?,
                        CompositeAlphaFlagBitsKHR::POST_MULTIPLIED => f.write_str("POST_MULTIPLIED")?,
                        CompositeAlphaFlagBitsKHR::INHERIT => f.write_str("INHERIT")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for SurfaceTransformFlagBitsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(SurfaceTransformFlagBitsKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == SurfaceTransformFlagBitsKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        SurfaceTransformFlagBitsKHR::IDENTITY => f.write_str("IDENTITY")?,
                        SurfaceTransformFlagBitsKHR::ROTATE90 => f.write_str("ROTATE90")?,
                        SurfaceTransformFlagBitsKHR::ROTATE180 => f.write_str("ROTATE180")?,
                        SurfaceTransformFlagBitsKHR::ROTATE270 => f.write_str("ROTATE270")?,
                        SurfaceTransformFlagBitsKHR::HORIZONTAL_MIRROR => f.write_str("HORIZONTAL_MIRROR")?,
                        SurfaceTransformFlagBitsKHR::HORIZONTAL_MIRROR_ROTATE90 => {
                            f.write_str("HORIZONTAL_MIRROR_ROTATE90")?
                        },
                        SurfaceTransformFlagBitsKHR::HORIZONTAL_MIRROR_ROTATE180 => {
                            f.write_str("HORIZONTAL_MIRROR_ROTATE180")?
                        },
                        SurfaceTransformFlagBitsKHR::HORIZONTAL_MIRROR_ROTATE270 => {
                            f.write_str("HORIZONTAL_MIRROR_ROTATE270")?
                        },
                        SurfaceTransformFlagBitsKHR::INHERIT => f.write_str("INHERIT")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl SurfaceCapabilitiesKHR {
    ...
    ///Sets the value of [`Self::min_image_count`]
    pub fn with_min_image_count(mut self, value: u32) -> Self {
        self.min_image_count = value;
        self
    }
    ///Sets the value of [`Self::max_image_count`]
    pub fn with_max_image_count(mut self, value: u32) -> Self {
        self.max_image_count = value;
        self
    }
    ///Sets the value of [`Self::current_extent`]
    pub fn with_current_extent(mut self, value: crate::vulkan1_0::Extent2D) -> Self {
        self.current_extent = value;
        self
    }
    ///Sets the value of [`Self::min_image_extent`]
    pub fn with_min_image_extent(mut self, value: crate::vulkan1_0::Extent2D) -> Self {
        self.min_image_extent = value;
        self
    }
    ///Sets the value of [`Self::max_image_extent`]
    pub fn with_max_image_extent(mut self, value: crate::vulkan1_0::Extent2D) -> Self {
        self.max_image_extent = value;
        self
    }
    ///Sets the value of [`Self::max_image_array_layers`]
    pub fn with_max_image_array_layers(mut self, value: u32) -> Self {
        self.max_image_array_layers = value;
        self
    }
    ///Sets the value of [`Self::supported_transforms`]
    pub fn with_supported_transforms(
        mut self,
        value: crate::extensions::khr_display::SurfaceTransformFlagsKHR,
    ) -> Self {
        self.supported_transforms = value;
    ...
    ///Sets the value of [`Self::supported_composite_alpha`]
    pub fn with_supported_composite_alpha(
        mut self,
        value: crate::extensions::khr_surface::CompositeAlphaFlagsKHR,
    ) -> Self {
        self.supported_composite_alpha = value;
    ...
    ///Sets the value of [`Self::supported_usage_flags`]
    pub fn with_supported_usage_flags(mut self, value: crate::vulkan1_0::ImageUsageFlags) -> Self {
        self.supported_usage_flags = value;
        self
    }
}
...
impl SurfaceFormatKHR {
    ...
    ///Sets the value of [`Self::color_space`]
    pub fn with_color_space(mut self, value: crate::extensions::khr_surface::ColorSpaceKHR) -> Self {
        self.color_space = value;
        self
    }
}
...
impl PhysicalDevice {
    ...
    pub unsafe fn get_physical_device_surface_formats_khr(
        ...
        let mut p_surface_formats = SmallVec::<SurfaceFormatKHR>::with_capacity(p_surface_format_count as usize);
        let _return = _function(
            self.as_raw(),
            surface.unwrap_or_default(),
