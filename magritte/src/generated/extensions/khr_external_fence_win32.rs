...
/// - [`p_get_win32_handle_info`] is a pointer to a [`FenceGetWin32HandleInfoKHR`] structure
...
pub type FNGetFenceWin32HandleKhr = Option<
    for<'lt> unsafe extern "system" fn(
        device: Device,
        p_get_win32_handle_info: *const FenceGetWin32HandleInfoKHR<'lt>,
        p_handle: *mut HANDLE,
    ) -> VulkanResultCodes,
>;
...
/// - [`p_import_fence_win32_handle_info`] is a pointer to a [`ImportFenceWin32HandleInfoKHR`]
...
///## Valid Usage (Implicit)
/// - [`device`] **must**  be a valid [`Device`] handle
/// - [`p_import_fence_win32_handle_info`] **must**  be a valid pointer to a valid
...
pub type FNImportFenceWin32HandleKhr = Option<
    for<'lt> unsafe extern "system" fn(
        device: Device,
        p_import_fence_win32_handle_info: *const ImportFenceWin32HandleInfoKHR<'lt>,
    ) -> VulkanResultCodes,
>;
...
impl<'lt> ImportFenceWin32HandleInfoKHR<'lt> {
    ...
    pub fn make_static(mut self) -> ImportFenceWin32HandleInfoKHR<'static> {
        unsafe {
...
impl<'lt> FenceGetWin32HandleInfoKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> FenceGetWin32HandleInfoKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    pub unsafe fn get_fence_win32_handle_khr<'lt>(
        self: &Unique<Device>,
        p_get_win32_handle_info: &FenceGetWin32HandleInfoKHR<'lt>,
    ) -> VulkanResult<HANDLE> {
        ...
        let _return = _function(
            self.as_raw(),
            p_get_win32_handle_info as *const FenceGetWin32HandleInfoKHR<'lt>,
            &mut p_handle,
        );
        match _return {
...
impl Device {
    ...
    pub unsafe fn import_fence_win32_handle_khr<'lt>(
        self: &Unique<Device>,
        p_import_fence_win32_handle_info: &ImportFenceWin32HandleInfoKHR<'lt>,
    ) -> VulkanResult<()> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
        ...
        let _return = _function(
            self.as_raw(),
            p_import_fence_win32_handle_info as *const ImportFenceWin32HandleInfoKHR<'lt>,
        );
        match _return {
