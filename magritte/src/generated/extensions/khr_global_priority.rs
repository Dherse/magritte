...
use crate::{
    core::MAX_GLOBAL_PRIORITY_SIZE_KHR,
...
impl std::fmt::Debug for QueueGlobalPriorityKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(QueueGlobalPriorityKHR);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == QueueGlobalPriorityKHR::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        QueueGlobalPriorityKHR::LOW => f.write_str("LOW")?,
                        QueueGlobalPriorityKHR::MEDIUM => f.write_str("MEDIUM")?,
                        QueueGlobalPriorityKHR::HIGH => f.write_str("HIGH")?,
                        QueueGlobalPriorityKHR::REALTIME => f.write_str("REALTIME")?,
...
impl<'lt> DeviceQueueGlobalPriorityCreateInfoKHR<'lt> {
    ...
    pub fn make_static(mut self) -> DeviceQueueGlobalPriorityCreateInfoKHR<'static> {
        unsafe {
...
impl<'lt> PhysicalDeviceGlobalPriorityQueryFeaturesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PhysicalDeviceGlobalPriorityQueryFeaturesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> QueueFamilyGlobalPriorityPropertiesKHR<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> QueueFamilyGlobalPriorityPropertiesKHR<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    pub fn set_priorities(
        &mut self,
        value: [crate::extensions::khr_global_priority::QueueGlobalPriorityKHR;
            crate::core::MAX_GLOBAL_PRIORITY_SIZE_KHR as usize],
    ) -> &mut Self {
