...
//! capabilities vary between shader stages? **RESOLVED** : No, if the capability is supported in
//! any stage it must be
...
//! * 2017-09-05
//! * No known IP claims.
//! * - This extension requires [`SPV_KHR_variable_pointers`](https://htmlpreview.github.io/?https://github.com/KhronosGroup/SPIRV-Registry/blob/master/extensions/KHR/SPV_KHR_variable_pointers.html)
//!   - Promoted to Vulkan 1.1 Core
//! * - John Kessenich, Google  - Neil Henning, Codeplay  - David Neto, Google  - Daniel Koch,
//!   Nvidia  - Graeme Leese, Broadcom  - Weifeng Zhang, Qualcomm  - Stephen Clarke, Imagination
//!   Technologies  - Jason Ekstrand, Intel  - Jesse Hall, Google
//!# Related
