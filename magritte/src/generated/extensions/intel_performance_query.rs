...
impl std::fmt::Debug for PerformanceConfigurationTypeINTEL {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceConfigurationTypeINTEL);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceConfigurationTypeINTEL::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceConfigurationTypeINTEL::COMMAND_QUEUE_METRICS_DISCOVERY_ACTIVATED => {
                            f.write_str("COMMAND_QUEUE_METRICS_DISCOVERY_ACTIVATED")?
                        },
...
impl std::fmt::Debug for QueryPoolSamplingModeINTEL {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(QueryPoolSamplingModeINTEL);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == QueryPoolSamplingModeINTEL::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        QueryPoolSamplingModeINTEL::MANUAL => f.write_str("MANUAL")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for PerformanceOverrideTypeINTEL {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceOverrideTypeINTEL);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceOverrideTypeINTEL::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceOverrideTypeINTEL::NULL_HARDWARE => f.write_str("NULL_HARDWARE")?,
                        PerformanceOverrideTypeINTEL::FLUSH_GPU_CACHES => f.write_str("FLUSH_GPU_CACHES")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for PerformanceParameterTypeINTEL {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceParameterTypeINTEL);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceParameterTypeINTEL::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceParameterTypeINTEL::HW_COUNTERS_SUPPORTED => f.write_str("HW_COUNTERS_SUPPORTED")?,
                        PerformanceParameterTypeINTEL::STREAM_MARKER_VALID_BITS => {
                            f.write_str("STREAM_MARKER_VALID_BITS")?
                        },
                        _ => f.write_str("invalid")?,
                    }
                }
...
impl std::fmt::Debug for PerformanceValueTypeINTEL {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(PerformanceValueTypeINTEL);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == PerformanceValueTypeINTEL::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        PerformanceValueTypeINTEL::UINT32 => f.write_str("UINT32")?,
                        PerformanceValueTypeINTEL::UINT64 => f.write_str("UINT64")?,
                        PerformanceValueTypeINTEL::FLOAT => f.write_str("FLOAT")?,
                        PerformanceValueTypeINTEL::BOOL => f.write_str("BOOL")?,
                        PerformanceValueTypeINTEL::STRING => f.write_str("STRING")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl PerformanceValueINTEL {
    ...
    ///Sets the value of [`Self::type_`]
    pub fn with_type_(mut self, value: crate::extensions::intel_performance_query::PerformanceValueTypeINTEL) -> Self {
        self.type_ = value;
        self
    }
    ///Sets the value of [`Self::data`]
    pub fn with_data(mut self, value: crate::extensions::intel_performance_query::PerformanceValueDataINTEL) -> Self {
        self.data = value;
        self
    }
}
...
impl<'lt> QueryPoolPerformanceQueryCreateInfoINTEL<'lt> {
    ...
    pub fn make_static(mut self) -> QueryPoolPerformanceQueryCreateInfoINTEL<'static> {
        unsafe {
...
impl<'lt> PerformanceMarkerInfoINTEL<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceMarkerInfoINTEL<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the value of [`Self::marker`]
    pub fn with_marker(mut self, value: u64) -> Self {
        self.marker = value;
        self
    }
}
...
impl<'lt> PerformanceStreamMarkerInfoINTEL<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceStreamMarkerInfoINTEL<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> PerformanceOverrideInfoINTEL<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceOverrideInfoINTEL<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::enable`]
    pub fn with_enable_raw(mut self, value: Bool32) -> Self {
        self.enable = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::enable`]
    pub fn with_enable(mut self, value: bool) -> Self {
        self.enable = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::parameter`]
    pub fn with_parameter(mut self, value: u64) -> Self {
        self.parameter = value;
        self
    }
}
...
impl<'lt> PerformanceConfigurationAcquireInfoINTEL<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> PerformanceConfigurationAcquireInfoINTEL<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl PerformanceConfigurationINTEL {
    ...
    pub fn set_name(self: &Unique<Self>, name: &std::ffi::CStr) {
        ...
        let info = crate::generated::extensions::ext_debug_utils::DebugUtilsObjectNameInfoEXT::default()
            .with_object_type(crate::generated::vulkan1_0::ObjectType::PERFORMANCE_CONFIGURATION_INTEL)
