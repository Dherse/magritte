...
impl<'lt> ImagePipeSurfaceCreateInfoFUCHSIA<'lt> {
    ...
    pub fn make_static(mut self) -> ImagePipeSurfaceCreateInfoFUCHSIA<'static> {
        unsafe {
    ...
    ///Sets the raw value of [`Self::image_pipe_handle`]
    pub fn with_image_pipe_handle_raw(mut self, value: zx_handle_t) -> Self {
        self.image_pipe_handle = value;
        self
    }
    ...
    ///Sets the value of [`Self::image_pipe_handle`]
    pub fn with_image_pipe_handle(mut self, value: crate::native::zx_handle_t) -> Self {
        self.image_pipe_handle = value;
        self
    }
}
