...
impl std::fmt::Debug for DebugReportObjectTypeEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(DebugReportObjectTypeEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == DebugReportObjectTypeEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        DebugReportObjectTypeEXT::UNKNOWN => f.write_str("UNKNOWN")?,
                        DebugReportObjectTypeEXT::INSTANCE => f.write_str("INSTANCE")?,
                        DebugReportObjectTypeEXT::PHYSICAL_DEVICE => f.write_str("PHYSICAL_DEVICE")?,
                        DebugReportObjectTypeEXT::DEVICE => f.write_str("DEVICE")?,
                        DebugReportObjectTypeEXT::QUEUE => f.write_str("QUEUE")?,
                        DebugReportObjectTypeEXT::SEMAPHORE => f.write_str("SEMAPHORE")?,
                        DebugReportObjectTypeEXT::COMMAND_BUFFER => f.write_str("COMMAND_BUFFER")?,
                        DebugReportObjectTypeEXT::FENCE => f.write_str("FENCE")?,
                        DebugReportObjectTypeEXT::DEVICE_MEMORY => f.write_str("DEVICE_MEMORY")?,
                        DebugReportObjectTypeEXT::BUFFER => f.write_str("BUFFER")?,
                        DebugReportObjectTypeEXT::IMAGE => f.write_str("IMAGE")?,
                        DebugReportObjectTypeEXT::EVENT => f.write_str("EVENT")?,
                        DebugReportObjectTypeEXT::QUERY_POOL => f.write_str("QUERY_POOL")?,
                        DebugReportObjectTypeEXT::BUFFER_VIEW => f.write_str("BUFFER_VIEW")?,
                        DebugReportObjectTypeEXT::IMAGE_VIEW => f.write_str("IMAGE_VIEW")?,
                        DebugReportObjectTypeEXT::SHADER_MODULE => f.write_str("SHADER_MODULE")?,
                        DebugReportObjectTypeEXT::PIPELINE_CACHE => f.write_str("PIPELINE_CACHE")?,
                        DebugReportObjectTypeEXT::PIPELINE_LAYOUT => f.write_str("PIPELINE_LAYOUT")?,
                        DebugReportObjectTypeEXT::RENDER_PASS => f.write_str("RENDER_PASS")?,
                        DebugReportObjectTypeEXT::PIPELINE => f.write_str("PIPELINE")?,
                        DebugReportObjectTypeEXT::DESCRIPTOR_SET_LAYOUT => f.write_str("DESCRIPTOR_SET_LAYOUT")?,
                        DebugReportObjectTypeEXT::SAMPLER => f.write_str("SAMPLER")?,
                        DebugReportObjectTypeEXT::DESCRIPTOR_POOL => f.write_str("DESCRIPTOR_POOL")?,
                        DebugReportObjectTypeEXT::DESCRIPTOR_SET => f.write_str("DESCRIPTOR_SET")?,
                        DebugReportObjectTypeEXT::FRAMEBUFFER => f.write_str("FRAMEBUFFER")?,
                        DebugReportObjectTypeEXT::COMMAND_POOL => f.write_str("COMMAND_POOL")?,
                        DebugReportObjectTypeEXT::SURFACE_KHR => f.write_str("SURFACE_KHR")?,
                        DebugReportObjectTypeEXT::SWAPCHAIN_KHR => f.write_str("SWAPCHAIN_KHR")?,
                        DebugReportObjectTypeEXT::DEBUG_REPORT_CALLBACK => f.write_str("DEBUG_REPORT_CALLBACK")?,
                        DebugReportObjectTypeEXT::DISPLAY_KHR => f.write_str("DISPLAY_KHR")?,
                        DebugReportObjectTypeEXT::DISPLAY_MODE_KHR => f.write_str("DISPLAY_MODE_KHR")?,
                        DebugReportObjectTypeEXT::VALIDATION_CACHE => f.write_str("VALIDATION_CACHE")?,
                        #[cfg(feature = "VK_KHR_sampler_ycbcr_conversion")]
                        DebugReportObjectTypeEXT::SAMPLER_YCBCR_CONVERSION => {
                            f.write_str("SAMPLER_YCBCR_CONVERSION")?
                        },
                        DebugReportObjectTypeEXT::DESCRIPTOR_UPDATE_TEMPLATE => {
                            f.write_str("DESCRIPTOR_UPDATE_TEMPLATE")?
                        },
                        #[cfg(feature = "VK_NVX_binary_import")]
                        DebugReportObjectTypeEXT::CU_MODULE_NVX => f.write_str("CU_MODULE_NVX")?,
                        #[cfg(feature = "VK_NVX_binary_import")]
                        DebugReportObjectTypeEXT::CU_FUNCTION_NVX => f.write_str("CU_FUNCTION_NVX")?,
                        #[cfg(feature = "VK_KHR_acceleration_structure")]
                        DebugReportObjectTypeEXT::ACCELERATION_STRUCTURE_KHR => {
                            f.write_str("ACCELERATION_STRUCTURE_KHR")?
                        },
                        #[cfg(feature = "VK_NV_ray_tracing")]
                        DebugReportObjectTypeEXT::ACCELERATION_STRUCTURE_NV => {
                            f.write_str("ACCELERATION_STRUCTURE_NV")?
                        },
                        #[cfg(feature = "VK_FUCHSIA_buffer_collection")]
                        DebugReportObjectTypeEXT::BUFFER_COLLECTION_FUCHSIA => {
                            f.write_str("BUFFER_COLLECTION_FUCHSIA")?
                        },
...
impl<'lt> DebugMarkerObjectNameInfoEXT<'lt> {
    ...
    pub fn make_static(mut self) -> DebugMarkerObjectNameInfoEXT<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::object_type`]
    pub fn with_object_type(mut self, value: crate::extensions::ext_debug_marker::DebugReportObjectTypeEXT) -> Self {
        self.object_type = value;
        self
    }
    ///Sets the value of [`Self::object`]
    pub fn with_object(mut self, value: u64) -> Self {
        self.object = value;
        self
    }
    ///Sets the value of [`Self::object_name`]
...
impl<'lt> DebugMarkerMarkerInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> DebugMarkerMarkerInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
    ...
    ///Sets the raw value of [`Self::marker_name`]
    pub fn with_marker_name_raw(mut self, value: *const c_char) -> Self {
        self.marker_name = value;
        self
    }
    ///Gets the value of [`Self::s_type`]
    ...
    ///Sets the value of [`Self::marker_name`]
    pub fn with_marker_name(mut self, value: *const std::os::raw::c_char) -> Self {
        self.marker_name = value;
        self
    }
    ///Sets the value of [`Self::color`]
