...
impl<'lt> XlibSurfaceCreateInfoKHR<'lt> {
    ...
    ///Sets the raw value of [`Self::window`]
    pub fn with_window_raw(mut self, value: Window) -> Self {
        self.window = value;
        self
    }
    ...
    pub fn set_dpy(&mut self, value: *mut crate::native::Display) -> &mut Self {
        self.dpy = value;
        self
    }
    ...
    ///Sets the value of [`Self::flags`]
    pub fn with_flags(mut self, value: crate::extensions::khr_xlib_surface::XlibSurfaceCreateFlagsKHR) -> Self {
        self.flags = value;
        self
    }
    ///Sets the value of [`Self::dpy`]
    pub fn with_dpy(mut self, value: *mut crate::native::Display) -> Self {
        self.dpy = value;
        self
    }
    ///Sets the value of [`Self::window`]
    pub fn with_window(mut self, value: crate::native::Window) -> Self {
        self.window = value;
        self
    }
}
