...
impl std::fmt::Debug for CoverageModulationModeNV {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(CoverageModulationModeNV);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == CoverageModulationModeNV::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        CoverageModulationModeNV::NONE => f.write_str("NONE")?,
                        CoverageModulationModeNV::RGB => f.write_str("RGB")?,
                        CoverageModulationModeNV::ALPHA => f.write_str("ALPHA")?,
                        CoverageModulationModeNV::RGBA => f.write_str("RGBA")?,
        ...
        f.debug_tuple(stringify!(CoverageModulationModeNV))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl<'lt> PipelineCoverageModulationStateCreateInfoNV<'lt> {
    ...
    ///Sets the raw value of [`Self::coverage_modulation_table_enable`]
    pub fn with_coverage_modulation_table_enable_raw(mut self, value: Bool32) -> Self {
        self.coverage_modulation_table_enable = value;
        self
    }
    ///Sets the raw value of [`Self::coverage_modulation_table`]
    pub fn with_coverage_modulation_table_raw(mut self, value: *const f32) -> Self {
        self.coverage_modulation_table = value;
        self
    }
    ...
    ///Sets the value of [`Self::coverage_modulation_mode`]
    pub fn with_coverage_modulation_mode(
        mut self,
        value: crate::extensions::nv_framebuffer_mixed_samples::CoverageModulationModeNV,
    ) -> Self {
        self.coverage_modulation_mode = value;
    ...
    ///Sets the value of [`Self::coverage_modulation_table_enable`]
    pub fn with_coverage_modulation_table_enable(mut self, value: bool) -> Self {
        self.coverage_modulation_table_enable = value as u8 as u32;
        self
    }
    ///Sets the value of [`Self::coverage_modulation_table_count`]
    pub fn with_coverage_modulation_table_count(mut self, value: u32) -> Self {
        self.coverage_modulation_table_count = value;
        self
    }
    ///Sets the value of [`Self::coverage_modulation_table`]
    pub fn with_coverage_modulation_table(mut self, value: &'lt [f32]) -> Self {
        let len_ = value.len() as u32;
        let len_ = len_;
        self.coverage_modulation_table = value.as_ptr();
        self.coverage_modulation_table_count = len_;
