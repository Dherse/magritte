...
impl std::fmt::Debug for ShaderInfoTypeAMD {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(ShaderInfoTypeAMD);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == ShaderInfoTypeAMD::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        ShaderInfoTypeAMD::STATISTICS => f.write_str("STATISTICS")?,
                        ShaderInfoTypeAMD::BINARY => f.write_str("BINARY")?,
                        ShaderInfoTypeAMD::DISASSEMBLY => f.write_str("DISASSEMBLY")?,
        ...
        f.debug_tuple(stringify!(ShaderInfoTypeAMD))
            .field(&Flags(*self))
            .finish()
    }
}
...
impl ShaderResourceUsageAMD {
    ...
    ///Sets the value of [`Self::num_used_vgprs`]
    pub fn with_num_used_vgprs(mut self, value: u32) -> Self {
        self.num_used_vgprs = value;
        self
    }
    ///Sets the value of [`Self::num_used_sgprs`]
    pub fn with_num_used_sgprs(mut self, value: u32) -> Self {
        self.num_used_sgprs = value;
        self
    }
    ///Sets the value of [`Self::lds_size_per_local_work_group`]
    pub fn with_lds_size_per_local_work_group(mut self, value: u32) -> Self {
        self.lds_size_per_local_work_group = value;
        self
    }
    ///Sets the value of [`Self::lds_usage_size_in_bytes`]
    pub fn with_lds_usage_size_in_bytes(mut self, value: usize) -> Self {
        self.lds_usage_size_in_bytes = value;
        self
    }
    ///Sets the value of [`Self::scratch_mem_usage_in_bytes`]
    pub fn with_scratch_mem_usage_in_bytes(mut self, value: usize) -> Self {
        self.scratch_mem_usage_in_bytes = value;
        self
    }
}
...
impl ShaderStatisticsInfoAMD {
    ...
    ///Sets the value of [`Self::shader_stage_mask`]
    pub fn with_shader_stage_mask(mut self, value: crate::vulkan1_0::ShaderStageFlags) -> Self {
        self.shader_stage_mask = value;
        self
    }
    ///Sets the value of [`Self::resource_usage`]
    pub fn with_resource_usage(mut self, value: crate::extensions::amd_shader_info::ShaderResourceUsageAMD) -> Self {
        self.resource_usage = value;
        self
    }
    ///Sets the value of [`Self::num_physical_vgprs`]
    pub fn with_num_physical_vgprs(mut self, value: u32) -> Self {
        self.num_physical_vgprs = value;
        self
    }
    ///Sets the value of [`Self::num_physical_sgprs`]
    pub fn with_num_physical_sgprs(mut self, value: u32) -> Self {
        self.num_physical_sgprs = value;
        self
    }
    ///Sets the value of [`Self::num_available_vgprs`]
    pub fn with_num_available_vgprs(mut self, value: u32) -> Self {
        self.num_available_vgprs = value;
        self
    }
    ///Sets the value of [`Self::num_available_sgprs`]
    pub fn with_num_available_sgprs(mut self, value: u32) -> Self {
        self.num_available_sgprs = value;
        self
    }
    ///Sets the value of [`Self::compute_work_group_size`]
    pub fn with_compute_work_group_size(mut self, value: [u32; 3 as usize]) -> Self {
        self.compute_work_group_size = value;
        self
    }
}
