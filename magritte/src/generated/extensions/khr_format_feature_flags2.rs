...
//!   `VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR` indicate that an implementation
...
//! * No known IP claims.
//! * - Lionel Landwerlin, Intel  - Jason Ekstrand, Intel  - Tobias Hector, AMD  - Spencer Fricke,
//!   Samsung Electronics  - Graeme Leese, Broadcom  - Jan-Harald Fredriksen, ARM
//!# Related
//! - [`FormatFeatureFlagBits2KHR`]
//! - [`FormatFeatureFlags2KHR`]
...
pub const KHR_FORMAT_FEATURE_FLAGS_2_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_KHR_format_feature_flags2");
