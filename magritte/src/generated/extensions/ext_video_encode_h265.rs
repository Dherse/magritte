...
/// - [`LOG2_PARALLEL_MERGE_LEVEL_MINUS2`] reports if setting non-zero value for
...
impl VideoEncodeH265CapabilityFlagBitsEXT {
    ...
    pub const LOG2_PARALLEL_MERGE_LEVEL_MINUS2: Self = Self(128);
...
impl std::fmt::Debug for VideoEncodeH265CapabilityFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265CapabilityFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265CapabilityFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265CapabilityFlagBitsEXT::SEPARATE_COLOUR_PLANE => {
                            f.write_str("SEPARATE_COLOUR_PLANE")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::SCALING_LISTS => f.write_str("SCALING_LISTS")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::SAMPLE_ADAPTIVE_OFFSET_ENABLED => {
                            f.write_str("SAMPLE_ADAPTIVE_OFFSET_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::PCM_ENABLE => f.write_str("PCM_ENABLE")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::SPS_TEMPORAL_MVP_ENABLED => {
                            f.write_str("SPS_TEMPORAL_MVP_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::HRD_COMPLIANCE => f.write_str("HRD_COMPLIANCE")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::INIT_QP_MINUS26 => f.write_str("INIT_QP_MINUS26")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::LOG2_PARALLEL_MERGE_LEVEL_MINUS2 => {
                            f.write_str("LOG2_PARALLEL_MERGE_LEVEL_MINUS2")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::SIGN_DATA_HIDING_ENABLED => {
                            f.write_str("SIGN_DATA_HIDING_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::TRANSFORM_SKIP_ENABLED => {
                            f.write_str("TRANSFORM_SKIP_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT => {
                            f.write_str("PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::WEIGHTED_PRED => f.write_str("WEIGHTED_PRED")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::WEIGHTED_BIPRED => f.write_str("WEIGHTED_BIPRED")?,
                        VideoEncodeH265CapabilityFlagBitsEXT::WEIGHTED_PRED_NO_TABLE => {
                            f.write_str("WEIGHTED_PRED_NO_TABLE")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::TRANSQUANT_BYPASS_ENABLED => {
                            f.write_str("TRANSQUANT_BYPASS_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::ENTROPY_CODING_SYNC_ENABLED => {
                            f.write_str("ENTROPY_CODING_SYNC_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::DEBLOCKING_FILTER_OVERRIDE_ENABLED => {
                            f.write_str("DEBLOCKING_FILTER_OVERRIDE_ENABLED")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::MULTIPLE_TILE_PER_FRAME => {
                            f.write_str("MULTIPLE_TILE_PER_FRAME")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::MULTIPLE_SLICE_PER_TILE => {
                            f.write_str("MULTIPLE_SLICE_PER_TILE")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::MULTIPLE_TILE_PER_SLICE => {
                            f.write_str("MULTIPLE_TILE_PER_SLICE")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::SLICE_SEGMENT_CTB_COUNT => {
                            f.write_str("SLICE_SEGMENT_CTB_COUNT")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::ROW_UNALIGNED_SLICE_SEGMENT => {
                            f.write_str("ROW_UNALIGNED_SLICE_SEGMENT")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::DEPENDENT_SLICE_SEGMENT => {
                            f.write_str("DEPENDENT_SLICE_SEGMENT")?
                        },
                        VideoEncodeH265CapabilityFlagBitsEXT::DIFFERENT_SLICE_TYPE => {
...
impl std::fmt::Debug for VideoEncodeH265InputModeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265InputModeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265InputModeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265InputModeFlagBitsEXT::FRAME => f.write_str("FRAME")?,
                        VideoEncodeH265InputModeFlagBitsEXT::SLICE_SEGMENT => f.write_str("SLICE_SEGMENT")?,
                        VideoEncodeH265InputModeFlagBitsEXT::NON_VCL => f.write_str("NON_VCL")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for VideoEncodeH265OutputModeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265OutputModeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265OutputModeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265OutputModeFlagBitsEXT::FRAME => f.write_str("FRAME")?,
                        VideoEncodeH265OutputModeFlagBitsEXT::SLICE_SEGMENT => f.write_str("SLICE_SEGMENT")?,
                        VideoEncodeH265OutputModeFlagBitsEXT::NON_VCL => f.write_str("NON_VCL")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for VideoEncodeH265RateControlStructureFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265RateControlStructureFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265RateControlStructureFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265RateControlStructureFlagBitsEXT::UNKNOWN => f.write_str("UNKNOWN")?,
                        VideoEncodeH265RateControlStructureFlagBitsEXT::FLAT => f.write_str("FLAT")?,
                        VideoEncodeH265RateControlStructureFlagBitsEXT::DYADIC => f.write_str("DYADIC")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for VideoEncodeH265CtbSizeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265CtbSizeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265CtbSizeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265CtbSizeFlagBitsEXT::_16 => f.write_str("16")?,
                        VideoEncodeH265CtbSizeFlagBitsEXT::_32 => f.write_str("32")?,
                        VideoEncodeH265CtbSizeFlagBitsEXT::_64 => f.write_str("64")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl std::fmt::Debug for VideoEncodeH265TransformBlockSizeFlagBitsEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        struct Flags(VideoEncodeH265TransformBlockSizeFlagBitsEXT);
        impl std::fmt::Debug for Flags {
            #[allow(unused_assignments, unused_mut, unused_variables)]
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265TransformBlockSizeFlagBitsEXT::empty() {
                    f.write_str("empty")?;
                } else {
                    match self.0 {
                        VideoEncodeH265TransformBlockSizeFlagBitsEXT::_4 => f.write_str("4")?,
                        VideoEncodeH265TransformBlockSizeFlagBitsEXT::_8 => f.write_str("8")?,
                        VideoEncodeH265TransformBlockSizeFlagBitsEXT::_16 => f.write_str("16")?,
                        VideoEncodeH265TransformBlockSizeFlagBitsEXT::_32 => f.write_str("32")?,
                        _ => f.write_str("invalid")?,
                    }
                }
                Ok(())
...
impl VideoEncodeH265CapabilityFlagsEXT {
    ...
    pub const fn all() -> Self {
        ...
        {
            all |= Self::INIT_QP_MINUS26;
        }
        {
            all |= Self::LOG2_PARALLEL_MERGE_LEVEL_MINUS2;
        }
        {
        ...
        impl std::fmt::Debug for Flags {
            ...
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
                if self.0 == VideoEncodeH265CapabilityFlagsEXT::empty() {
                    ...
                    if self.0.contains(VideoEncodeH265CapabilityFlagsEXT::INIT_QP_MINUS26) {
                        if !first {
                            f.write_str(" | ")?;
                        }
                        first = false;
                        f.write_str(stringify!(INIT_QP_MINUS26))?;
                    }
                    if self
                        .0
                        .contains(VideoEncodeH265CapabilityFlagsEXT::LOG2_PARALLEL_MERGE_LEVEL_MINUS2)
                    {
                        if !first {
                            f.write_str(" | ")?;
                        }
                        first = false;
                        f.write_str(stringify!(LOG2_PARALLEL_MERGE_LEVEL_MINUS2))?;
                    }
                    if self
                        .0
...
/// - [`min_log2_min_luma_coding_block_size_minus3`] reports the minimum value that may be set for
///   log2_min_luma_coding_block_size_minus3 in StdVideoH265SequenceParameterSet.
/// - [`max_log2_min_luma_coding_block_size_minus3`] reports the maximum value that may be set for
///   log2_min_luma_coding_block_size_minus3 in StdVideoH265SequenceParameterSet.
/// - [`min_log2_min_luma_transform_block_size_minus2`] reports the minimum value that may be set
///   for log2_min_luma_transform_block_size_minus2 in StdVideoH265SequenceParameterSet.
/// - [`max_log2_min_luma_transform_block_size_minus2`] reports the maximum value that may be set
///   for log2_min_luma_transform_block_size_minus2 in StdVideoH265SequenceParameterSet.
...
pub struct VideoEncodeH265CapabilitiesEXT<'lt> {
    ...
    ///[`min_log2_min_luma_coding_block_size_minus3`] reports the minimum value that
    ///may be set for log2_min_luma_coding_block_size_minus3 in
    ///StdVideoH265SequenceParameterSet.
    pub min_log2_min_luma_coding_block_size_minus3: u8,
    ///[`max_log2_min_luma_coding_block_size_minus3`] reports the maximum value that
    ///may be set for log2_min_luma_coding_block_size_minus3 in
    ///StdVideoH265SequenceParameterSet.
    pub max_log2_min_luma_coding_block_size_minus3: u8,
    ///[`min_log2_min_luma_transform_block_size_minus2`] reports the minimum value
    ///that may be set for log2_min_luma_transform_block_size_minus2 in
    ///StdVideoH265SequenceParameterSet.
    pub min_log2_min_luma_transform_block_size_minus2: u8,
    ///[`max_log2_min_luma_transform_block_size_minus2`] reports the maximum value
    ///that may be set for log2_min_luma_transform_block_size_minus2 in
    ///StdVideoH265SequenceParameterSet.
...
impl<'lt> Default for VideoEncodeH265CapabilitiesEXT<'lt> {
    fn default() -> Self {
        Self {
            ...
            min_log2_min_luma_coding_block_size_minus3: 0,
            max_log2_min_luma_coding_block_size_minus3: 0,
            min_log2_min_luma_transform_block_size_minus2: 0,
            max_log2_min_luma_transform_block_size_minus2: 0,
...
impl<'lt> VideoEncodeH265CapabilitiesEXT<'lt> {
    ...
    pub fn make_static(mut self) -> VideoEncodeH265CapabilitiesEXT<'static> {
        unsafe {
    ...
    ///Gets the value of [`Self::min_log2_min_luma_coding_block_size_minus3`]
    pub fn min_log2_min_luma_coding_block_size_minus3(&self) -> u8 {
        self.min_log2_min_luma_coding_block_size_minus3
    }
    ///Gets the value of [`Self::max_log2_min_luma_coding_block_size_minus3`]
    pub fn max_log2_min_luma_coding_block_size_minus3(&self) -> u8 {
        self.max_log2_min_luma_coding_block_size_minus3
    }
    ///Gets the value of [`Self::min_log2_min_luma_transform_block_size_minus2`]
    pub fn min_log2_min_luma_transform_block_size_minus2(&self) -> u8 {
        self.min_log2_min_luma_transform_block_size_minus2
    }
    ///Gets the value of [`Self::max_log2_min_luma_transform_block_size_minus2`]
    pub fn max_log2_min_luma_transform_block_size_minus2(&self) -> u8 {
    ...
    /// [`Self::min_log2_min_luma_coding_block_size_minus3`]
    pub fn min_log2_min_luma_coding_block_size_minus3_mut(&mut self) -> &mut u8 {
        &mut self.min_log2_min_luma_coding_block_size_minus3
    }
    ///Gets a mutable reference to the value of
    /// [`Self::max_log2_min_luma_coding_block_size_minus3`]
    pub fn max_log2_min_luma_coding_block_size_minus3_mut(&mut self) -> &mut u8 {
        &mut self.max_log2_min_luma_coding_block_size_minus3
    }
    ///Gets a mutable reference to the value of
    /// [`Self::min_log2_min_luma_transform_block_size_minus2`]
    pub fn min_log2_min_luma_transform_block_size_minus2_mut(&mut self) -> &mut u8 {
        &mut self.min_log2_min_luma_transform_block_size_minus2
    }
    ///Gets a mutable reference to the value of
    /// [`Self::max_log2_min_luma_transform_block_size_minus2`]
    pub fn max_log2_min_luma_transform_block_size_minus2_mut(&mut self) -> &mut u8 {
        &mut self.max_log2_min_luma_transform_block_size_minus2
    }
...
impl<'lt> VideoEncodeH265RateControlInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH265RateControlInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> VideoEncodeH265RateControlLayerInfoEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH265RateControlLayerInfoEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl<'lt> VideoEncodeH265ProfileEXT<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> VideoEncodeH265ProfileEXT<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
///   [`reference_list0_entry_count`][`VideoEncodeH265DpbSlotInfoEXT`] structures specifying the
...
///   [`reference_list1_entry_count`][`VideoEncodeH265DpbSlotInfoEXT`] structures specifying the
...
pub struct VideoEncodeH265ReferenceListsEXT<'lt> {
    ...
    ///[`reference_list0_entries`] is a pointer to an array of
    ///[`reference_list0_entry_count`][`VideoEncodeH265DpbSlotInfoEXT`]
    ///structures specifying the reference list L0 entries for the current
    ///picture.
    pub reference_list0_entries: *const VideoEncodeH265DpbSlotInfoEXT<'lt>,
    ...
    ///[`reference_list1_entries`] is a pointer to an array of
    ///[`reference_list1_entry_count`][`VideoEncodeH265DpbSlotInfoEXT`]
    ///structures specifying the reference list L1 entries for the current
    ///picture.
    pub reference_list1_entries: *const VideoEncodeH265DpbSlotInfoEXT<'lt>,
...
impl<'lt> VideoEncodeH265ReferenceListsEXT<'lt> {
    ...
    pub fn reference_list0_entries_raw(&self) -> *const VideoEncodeH265DpbSlotInfoEXT<'lt> {
        self.reference_list0_entries
    }
    ///Gets the raw value of [`Self::reference_list1_entries`]
    pub fn reference_list1_entries_raw(&self) -> *const VideoEncodeH265DpbSlotInfoEXT<'lt> {
    ...
    ///This function converts a pointer into a value which may be invalid, make sure
    ///that the pointer is valid before dereferencing.
    pub unsafe fn reference_list0_entries(&self) -> &[VideoEncodeH265DpbSlotInfoEXT<'lt>] {
    ...
    ///This function converts a pointer into a value which may be invalid, make sure
    ///that the pointer is valid before dereferencing.
    pub unsafe fn reference_list1_entries(&self) -> &[VideoEncodeH265DpbSlotInfoEXT<'lt>] {
