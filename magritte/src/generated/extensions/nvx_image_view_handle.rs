...
impl<'lt> ImageViewHandleInfoNVX<'lt> {
    ...
    pub fn make_static(mut self) -> ImageViewHandleInfoNVX<'static> {
        unsafe {
    ...
    ///Sets the value of [`Self::descriptor_type`]
    pub fn with_descriptor_type(mut self, value: crate::vulkan1_0::DescriptorType) -> Self {
        self.descriptor_type = value;
        self
    }
    ///Sets the value of [`Self::sampler`]
    pub fn with_sampler(mut self, value: crate::vulkan1_0::Sampler) -> Self {
        self.sampler = value;
        self
    }
}
...
impl<'lt> ImageViewAddressPropertiesNVX<'lt> {
    ///Creates a static version of this structure
    pub fn make_static(mut self) -> ImageViewAddressPropertiesNVX<'static> {
        unsafe {
            self.p_next = std::ptr::null_mut() as _;
            std::mem::transmute(self)
        }
...
impl Device {
    ...
    ) -> VulkanResult<ImageViewAddressPropertiesNVX<'static>> {
        #[cfg(any(debug_assertions, feature = "assertions"))]
        let _function = self
            .vtable()
            .nvx_image_view_handle()
