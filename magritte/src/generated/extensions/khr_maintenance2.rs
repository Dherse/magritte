...
//! as follows:
//! - Allow the application to specify which aspect of an input attachment might be read for a given
//!   subpass.
//! - Allow implementations to express the clipping behavior of points.
//! - Allow creating images with usage flags that may not be supported for the base image’s format,
...
//! - Allow the application to select between an upper-left and lower-left origin for the
...
//! - Extending [`ImageCreateFlagBits`]:  - `VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR`  -
//!   `VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR`
//! - Extending [`ImageLayout`]:  - `VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR`
//!   - `VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR`
//! - Extending [`PointClippingBehavior`]:  - `VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES_KHR`  -
//!   `VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY_KHR`
//! - Extending [`StructureType`]:  - `VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO_KHR`  -
...
//! * - Michael Worcester, Imagination Technologies  - Stuart Smith, Imagination Technologies  -
//!   Jeff Bolz, NVIDIA  - Daniel Koch, NVIDIA  - Jan-Harald Fredriksen, ARM  - Daniel Rakos, AMD  -
//!   Neil Henning, Codeplay  - Piers Daniell, NVIDIA
//!# Related
...
pub const KHR_MAINTENANCE_2_EXTENSION_NAME: &'static CStr = crate::cstr!("VK_KHR_maintenance2");
