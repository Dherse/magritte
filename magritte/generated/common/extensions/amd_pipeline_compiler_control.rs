...
impl std::ops::BitXor for PipelineCompilerControlFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::BitAnd for PipelineCompilerControlFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::Sub for PipelineCompilerControlFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::Not for PipelineCompilerControlFlagsAMD {
    type Output = Self;
    #[inline]
    fn not(self) -> Self {
        self.complement()
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for PipelineCompilerControlFlagsAMD {
    type LowLevel = Self;
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for PipelineCompilerControlFlagsAMD {
...
impl Default for PipelineCompilerControlFlagBitsAMD {
    #[inline]
    fn default() -> Self {
        Self::empty()
    }
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for PipelineCompilerControlFlagBitsAMD {
    type LowLevel = Self;
    unsafe fn into_low_level(
        &self,
        context: &std::sync::Arc<crate::context::Context>,
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for PipelineCompilerControlFlagBitsAMD {
    unsafe fn from_low_level(
        context: &std::sync::Arc<crate::context::Context>,
        value: <Self as crate::conv::IntoLowLevel>::LowLevel,
    ) -> Self {
