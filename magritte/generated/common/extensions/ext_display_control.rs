...
impl DisplayPowerStateEXT {
    ...
    pub const fn from_bits(bits: i32) -> Option<Self> {
        match bits {
            x if x == Self::Off.bits() => Some(Self::Off),
            x if x == Self::Suspend.bits() => Some(Self::Suspend),
            x if x == Self::On.bits() => Some(Self::On),
            _ => None,
        }
    }
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for DisplayPowerStateEXT {
    type LowLevel = Self;
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for DisplayPowerStateEXT {
...
impl DeviceEventTypeEXT {
    ...
    pub const fn from_bits(bits: i32) -> Option<Self> {
        match bits {
            x if x == Self::DisplayHotplug.bits() => Some(Self::DisplayHotplug),
            _ => None,
        }
    }
    ///Builds a bitmask from the bits of this variant without validating it
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for DeviceEventTypeEXT {
    type LowLevel = Self;
    unsafe fn into_low_level(
        &self,
        context: &std::sync::Arc<crate::context::Context>,
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for DeviceEventTypeEXT {
    unsafe fn from_low_level(
        context: &std::sync::Arc<crate::context::Context>,
        value: <Self as crate::conv::IntoLowLevel>::LowLevel,
    ) -> Self {
...
impl Default for DisplayEventTypeEXT {
    #[inline]
    fn default() -> Self {
        Self::empty()
    }
...
impl DisplayEventTypeEXT {
    ...
    pub const fn from_bits(bits: i32) -> Option<Self> {
        match bits {
            x if x == Self::FirstPixelOut.bits() => Some(Self::FirstPixelOut),
            _ => None,
        }
    }
    ///Builds a bitmask from the bits of this variant without validating it
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for DisplayEventTypeEXT {
    type LowLevel = Self;
    unsafe fn into_low_level(
        &self,
        context: &std::sync::Arc<crate::context::Context>,
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for DisplayEventTypeEXT {
    unsafe fn from_low_level(
        context: &std::sync::Arc<crate::context::Context>,
        value: <Self as crate::conv::IntoLowLevel>::LowLevel,
    ) -> Self {
