...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for ValidationCacheCreateFlagsEXT {
    type LowLevel = Self;
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for ValidationCacheCreateFlagsEXT {
...
impl Default for ValidationCacheHeaderVersionEXT {
    #[inline]
    fn default() -> Self {
        Self::empty()
    }
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for ValidationCacheHeaderVersionEXT {
    type LowLevel = Self;
    unsafe fn into_low_level(
        &self,
        context: &std::sync::Arc<crate::context::Context>,
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for ValidationCacheHeaderVersionEXT {
    unsafe fn from_low_level(
        context: &std::sync::Arc<crate::context::Context>,
        value: <Self as crate::conv::IntoLowLevel>::LowLevel,
    ) -> Self {
