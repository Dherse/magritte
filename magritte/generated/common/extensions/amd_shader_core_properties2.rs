...
impl std::ops::BitXor for ShaderCorePropertiesFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::BitAnd for ShaderCorePropertiesFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::Sub for ShaderCorePropertiesFlagsAMD {
    type Output = Self;
    #[inline]
...
impl std::ops::Not for ShaderCorePropertiesFlagsAMD {
    type Output = Self;
    #[inline]
    fn not(self) -> Self {
        self.complement()
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for ShaderCorePropertiesFlagsAMD {
    type LowLevel = Self;
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for ShaderCorePropertiesFlagsAMD {
...
#[cfg(feature = "native")]
unsafe impl crate::conv::IntoLowLevel for ShaderCorePropertiesFlagBitsAMD {
    type LowLevel = Self;
    unsafe fn into_low_level(
        &self,
        context: &std::sync::Arc<crate::context::Context>,
...
#[cfg(feature = "native")]
unsafe impl crate::conv::FromLowLevel for ShaderCorePropertiesFlagBitsAMD {
    unsafe fn from_low_level(
        context: &std::sync::Arc<crate::context::Context>,
        value: <Self as crate::conv::IntoLowLevel>::LowLevel,
    ) -> Self {
